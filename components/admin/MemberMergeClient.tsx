    ...
    <div style={{ display: 'grid', gap: '1.5rem' }}>
      ...
      {preview && (
        <div style={{ display: 'grid', gap: '1rem' }}>
          ...
          <div style={{ display: 'grid', gap: '1rem', gridTemplateColumns: '1fr 1fr' }}>
            <div style={cardStyle}>
              <div style={{ fontSize: '0.8125rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', color: 'var(--wa-success-dark)', marginBottom: '0.5rem' }}>Primary (kept)</div>
