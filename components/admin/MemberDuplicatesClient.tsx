                ...
                return (
                  <div key={m.id} style={{ padding: '1rem 1.125rem', background: 'var(--surface-container)', display: 'grid', gap: '0.75rem' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', flexWrap: 'wrap' }}>
                      ...
                      {idx === 0 && <span style={{ fontSize: '0.8125rem', fontWeight: 700, padding: '0.1rem 0.4rem', borderRadius: '9999px', background: 'rgba(74,155,79,0.1)', color: 'var(--color-green, #4a9b4f)', textTransform: 'uppercase' }}>Newest</span>}
                    </div>
