...
| PublicWioaScreening | model | public_wioa_screenings | 9 | [schema:2299](../../../prisma/schema.prisma#L2299) |
| JobPostingApplicationStatus | enum | job_posting_application_status | 6 | [schema:2316](../../../prisma/schema.prisma#L2316) |
| JobPostingApplication | model | job_posting_applications | 18 | [schema:2327](../../../prisma/schema.prisma#L2327) |
| ApplicationMessage | model | application_messages | 8 | [schema:2355](../../../prisma/schema.prisma#L2355) |
| PartnerOutreachLog | model | partner_outreach_logs | 10 | [schema:2371](../../../prisma/schema.prisma#L2371) |
| PortalWorkflowEvent | model | portal_workflow_events | 14 | [schema:2390](../../../prisma/schema.prisma#L2390) |
| AIJobMatchStatus | enum | ai_job_match_status | 7 | [schema:2413](../../../prisma/schema.prisma#L2413) |
| AIJobMatch | model | ai_job_matches | 10 | [schema:2425](../../../prisma/schema.prisma#L2425) |
| MentorSpecialty | model | mentor_specialties | 4 | [schema:2446](../../../prisma/schema.prisma#L2446) |
| Mentor | model | mentors | 17 | [schema:2457](../../../prisma/schema.prisma#L2457) |
| MentorSession | model | mentor_sessions | 13 | [schema:2480](../../../prisma/schema.prisma#L2480) |
| MentorSessionStatus | enum | Prisma default | 4 | [schema:2501](../../../prisma/schema.prisma#L2501) |
| CareerExperienceBand | enum | career_experience_band | 3 | [schema:2510](../../../prisma/schema.prisma#L2510) |
| CareerRecommendationType | enum | career_recommendation_type | 3 | [schema:2518](../../../prisma/schema.prisma#L2518) |
| OnetOccupation | model | onet_occupations | 21 | [schema:2526](../../../prisma/schema.prisma#L2526) |
| OnetOccupationSkill | model | onet_occupation_skills | 6 | [schema:2553](../../../prisma/schema.prisma#L2553) |
| OnetOccupationTask | model | onet_occupation_tasks | 5 | [schema:2566](../../../prisma/schema.prisma#L2566) |
| OnetOccupationTech | model | onet_occupation_tech | 5 | [schema:2578](../../../prisma/schema.prisma#L2578) |
| OnetRelatedOccupation | model | onet_related_occupations | 6 | [schema:2590](../../../prisma/schema.prisma#L2590) |
| CareerProgramMapping | model | career_program_mappings | 11 | [schema:2604](../../../prisma/schema.prisma#L2604) |
| CareerQuizRule | model | career_quiz_rules | 9 | [schema:2624](../../../prisma/schema.prisma#L2624) |
| MemberNextBestAction | model | member_next_best_actions | 12 | [schema:2638](../../../prisma/schema.prisma#L2638) |
| MemberPoints | model | member_points | 10 | [schema:2659](../../../prisma/schema.prisma#L2659) |
| PointsTransaction | model | points_transactions | 10 | [schema:2676](../../../prisma/schema.prisma#L2676) |
| ReferralCode | model | referral_codes | 5 | [schema:2700](../../../prisma/schema.prisma#L2700) |
| ReferralConversion | model | referral_conversions | 9 | [schema:2714](../../../prisma/schema.prisma#L2714) |
| CourseraCourseProgress | model | coursera_course_progress | 29 | [schema:2738](../../../prisma/schema.prisma#L2738) |
| CourseraCanonicalCourseMapping | model | coursera_canonical_course_mappings | 10 | [schema:2792](../../../prisma/schema.prisma#L2792) |
| CourseraCurriculumCourseMapping | model | coursera_curriculum_course_mappings | 9 | [schema:2815](../../../prisma/schema.prisma#L2815) |
| CourseraIdentityMapping | model | coursera_identity_mappings | 11 | [schema:2844](../../../prisma/schema.prisma#L2844) |
| CourseraBadgeProgress | model | coursera_badge_progress | 21 | [schema:2868](../../../prisma/schema.prisma#L2868) |
| AtRiskAlert | model | at_risk_alerts | 13 | [schema:2904](../../../prisma/schema.prisma#L2904) |
| MemberNudgeLog | model | member_nudge_logs | 7 | [schema:2930](../../../prisma/schema.prisma#L2930) |
| PlacementSurveyWave | enum | placement_survey_wave | 4 | [schema:2946](../../../prisma/schema.prisma#L2946) |
| PlacementSurvey | model | placement_surveys | 21 | [schema:2963](../../../prisma/schema.prisma#L2963) |
| TestimonialSource | enum | testimonial_source | 3 | [schema:3007](../../../prisma/schema.prisma#L3007) |
| TestimonialStatus | enum | testimonial_status | 4 | [schema:3015](../../../prisma/schema.prisma#L3015) |
| Testimonial | model | testimonials | 18 | [schema:3024](../../../prisma/schema.prisma#L3024) |
| CourseraSkillsetProgress | model | coursera_skillset_progress | 9 | [schema:3058](../../../prisma/schema.prisma#L3058) |
| MilestoneCascade | model | milestone_cascades | 23 | [schema:3085](../../../prisma/schema.prisma#L3085) |
| MemberFeedback | model | member_feedback | 8 | [schema:3131](../../../prisma/schema.prisma#L3131) |
| FeatureFlag | model | feature_flags | 9 | [schema:3151](../../../prisma/schema.prisma#L3151) |
| WebhookEvent | model | webhook_events | 13 | [schema:3175](../../../prisma/schema.prisma#L3175) |
| EmailTemplate | model | email_templates | 9 | [schema:3200](../../../prisma/schema.prisma#L3200) |
| Notification | model | notifications | 9 | [schema:3218](../../../prisma/schema.prisma#L3218) |
| PushSubscription | model | push_subscriptions | 8 | [schema:3240](../../../prisma/schema.prisma#L3240) |
| SavedJob | model | saved_jobs | 6 | [schema:3255](../../../prisma/schema.prisma#L3255) |
| WapJob | model | wap_jobs | 8 | [schema:3272](../../../prisma/schema.prisma#L3272) |
| TokenLinkType | enum | Prisma default | 3 | [schema:3291](../../../prisma/schema.prisma#L3291) |
| TokenizedLink | model | tokenized_link | 10 | [schema:3297](../../../prisma/schema.prisma#L3297) |
| UserTourState | model | user_tour_states | 9 | [schema:3320](../../../prisma/schema.prisma#L3320) |
