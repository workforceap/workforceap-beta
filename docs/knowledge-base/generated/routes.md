...
| /api/admin/members/\[id\]/program | route | PATCH | [app/api/admin/members/\[id\]/program/route.ts](../../../app/api/admin/members/%5Bid%5D/program/route.ts) | @/lib/auth/server:2, @/lib/auth/roles:3, @/lib/tenant/organization:5, @/lib/tenant/adminSubjectAccess:6, @/lib/db/withRequestGuc:15 |
...
| /api/admin/messages/stats | route | GET | [app/api/admin/messages/stats/route.ts](../../../app/api/admin/messages/stats/route.ts) | @/lib/auth/server:2, @/lib/auth/roles:3 |
...
| /api/admin/partners/\[id\]/approve | route | POST | [app/api/admin/partners/\[id\]/approve/route.ts](../../../app/api/admin/partners/%5Bid%5D/approve/route.ts) | @/lib/auth/server:2, @/lib/auth/roles:3, @/lib/tenant/withTenantScope:7, @/lib/tenant/organization:8, @/lib/db/withRequestGuc:10, @/lib/auth/roles:13 |
...
| /api/admin/partners/\[id\]/invite | route | POST | [app/api/admin/partners/\[id\]/invite/route.ts](../../../app/api/admin/partners/%5Bid%5D/invite/route.ts) | @/lib/auth/server:2, @/lib/auth/roles:3, @/lib/tenant/withTenantScope:5, @/lib/tenant/organization:6, @/lib/auth/supabaseAdminUsers:8, @/lib/db/withRequestGuc:11 |
...
| /api/admin/partners/\[id\]/reject | route | POST | [app/api/admin/partners/\[id\]/reject/route.ts](../../../app/api/admin/partners/%5Bid%5D/reject/route.ts) | @/lib/auth/server:2, @/lib/auth/roles:3, @/lib/tenant/withTenantScope:5, @/lib/tenant/organization:6, @/lib/db/withRequestGuc:12 |
...
| /api/admin/partners/invite | route | POST | [app/api/admin/partners/invite/route.ts](../../../app/api/admin/partners/invite/route.ts) | @/lib/auth/server:4, @/lib/auth/roles:5, @/lib/db/withRequestGuc:10 |
...
| /api/admin/reports/wioa/generate | route | POST, GET | [app/api/admin/reports/wioa/generate/route.ts](../../../app/api/admin/reports/wioa/generate/route.ts) | @/lib/auth/server:2, @/lib/auth/roles:3 |
...
| /api/admin/users | route | GET, POST | [app/api/admin/users/route.ts](../../../app/api/admin/users/route.ts) | @/lib/auth/server:4, @/lib/auth/roles:5, @/lib/tenant/organization:9, @/lib/tenant/withTenantScope:10, @/lib/auth/passwordReset:17, @/lib/auth/supabaseAdminUsers:18, @/lib/db/withRequestGuc:20 |
...
| /api/counselor/sessions/email-packet | route | POST | [app/api/counselor/sessions/email-packet/route.ts](../../../app/api/counselor/sessions/email-packet/route.ts) | @/lib/auth/server:4, @/lib/tenant/withTenantScope:6, @/lib/tenant/organization:7, @/lib/auth/actAsSubject:10, @/lib/db/withRequestGuc:15 |
...
| /api/cron/at-risk-check | route | GET, POST | [app/api/cron/at-risk-check/route.ts](../../../app/api/cron/at-risk-check/route.ts) | @/lib/cron/authorizeCronRequest:14 |
...
| /api/leads/careers | route | POST | [app/api/leads/careers/route.ts](../../../app/api/leads/careers/route.ts) | @/lib/rate-limit:3 |
...
| /api/member/assessment/submit | route | POST | [app/api/member/assessment/submit/route.ts](../../../app/api/member/assessment/submit/route.ts) | @/lib/auth/server:3, @/lib/db/withRequestGuc:14 |
...
| /api/member/certifications | route | GET, POST | [app/api/member/certifications/route.ts](../../../app/api/member/certifications/route.ts) | @/lib/auth/server:2, @/lib/auth/ensureUser:3, @/lib/db/withRequestGuc:11 |
...
| /api/referral-sources | route | GET | [app/api/referral-sources/route.ts](../../../app/api/referral-sources/route.ts) | @/lib/db/withRequestGuc:10 |
