# libraries: complete file catalog
...
| [lib/admin/analytics.ts](../../../lib/admin/analytics.ts) | 284 | administration | MemberStatusCounts:19, EnrollmentTrend:26, ProgramProgress:32, PlacementRate:38, CounselorLoad:44, AnalyticsOverview:49, summarizeProgramProgress:64, getAnalyticsOverview:93 |
...
| [lib/admin/assignableProgramOptions.test.ts](../../../lib/admin/assignableProgramOptions.test.ts) | 78 | administration |  |
| [lib/admin/assignableProgramOptions.ts](../../../lib/admin/assignableProgramOptions.ts) | 66 | administration | AssignableProgramOption:3, MemberProgramOption:5, buildAssignableProgramOptions:20, buildMemberProgramOptions:39 |
| [lib/admin/authUserLifecycle.ts](../../../lib/admin/authUserLifecycle.ts) | 117 | administration | retiredAuthEmail:10, DisableAuthUserResult:19, disableAuthUserForSoftDelete:30, ReenableAuthUserResult:55, reenableAuthUserAfterRestore:66 |
| [lib/admin/boardOutcomes.ts](../../../lib/admin/boardOutcomes.ts) | 1357 | administration | BoardOutcomesPeriod:26, BoardOutcomes:28, getBoardOutcomes:154, SMALL_SAMPLE_THRESHOLD:543, BoardSnapshotApplicationFunnel:545, BoardSnapshotActivity:553, BoardSnapshotCertifications:561, BoardSnapshotDataQuality:567, FunnelWaterfallStage:575, ApplicationQueueHealth:582, CohortMonth:588, PlacementActivityMonth:599, BoardSnapshotKpis:605, BoardSnapshot:626, buildPlacementActivitySeries:654, buildFunnelWaterfall:683, getBoardSnapshot:734, formatBoardSnapshotMarkdown:1114, formatBoardSnapshotPdf:1255 |
| [lib/admin/boardOutcomesFunnel.test.ts](../../../lib/admin/boardOutcomesFunnel.test.ts) | 25 | administration |  |
...
| [lib/admin/courseraDiagnostics.test.ts](../../../lib/admin/courseraDiagnostics.test.ts) | 65 | learning-coursera |  |
| [lib/admin/courseraDiagnostics.ts](../../../lib/admin/courseraDiagnostics.ts) | 104 | learning-coursera | MATCHED_COURSE_PROGRESS:5, diagnosticTenantFilter:28, LATEST_B4B_COURSE_PROGRESS:36, buildCompletionDriftQuery:44, DiagnosticProgram:62, buildCourseProgramIndex:65, courseMatchesAssignedProgram:82, deriveCourseraOverviewHealth:91 |
| [lib/admin/courseraDiagnosticsLoaders.test.ts](../../../lib/admin/courseraDiagnosticsLoaders.test.ts) | 101 | learning-coursera |  |
...
| [lib/admin/courseraEnrollmentEvidence.ts](../../../lib/admin/courseraEnrollmentEvidence.ts) | 25 | learning-coursera | EnrollmentSignal:1, hasRecentCourseraActivity:3, deriveEnrollmentSignal:11 |
| [lib/admin/courseraEnrollmentPipeline.ts](../../../lib/admin/courseraEnrollmentPipeline.ts) | 246 | learning-coursera | EnrollmentSignal:8, ENROLLMENT_SIGNAL_LABELS:15, EnrollmentPipelineRow:24, EnrollmentPipelineSummary:38, EnrollmentPipelineData:48, loadCourseraEnrollmentPipeline:67 |
...
| [lib/admin/courseraSyncDrift.test.ts](../../../lib/admin/courseraSyncDrift.test.ts) | 62 | learning-coursera |  |
| [lib/admin/courseraSyncDrift.ts](../../../lib/admin/courseraSyncDrift.ts) | 110 | learning-coursera | SyncDriftRawRow:13, SyncDriftRow:25, SyncDriftResult:35, SYNC_DRIFT_THRESHOLD_HOURS:39, SYNC_DRIFT_LIMIT:40, buildSyncDriftQuery:45, mapSyncDriftRows:79, loadSyncDriftPairs:96 |
...
| [lib/admin/cronRegistry.ts](../../../lib/admin/cronRegistry.ts) | 405 | administration | CronDef:8, CRON_REGISTRY:22, CRON_CATEGORY_COLOR:400 |
...
| [lib/admin/globalSearch.ts](../../../lib/admin/globalSearch.ts) | 61 | administration | GlobalSearchType:3, GlobalSearchResult:4, userSearchResult:15, globalSearchKey:39, rankGlobalSearchResults:54 |
...
| [lib/agents/gateway/startMemberSession.ts](../../../lib/agents/gateway/startMemberSession.ts) | 78 | libraries | startMemberAgentGatewaySession:22 |
| [lib/agents/gateway/toolDefinitions.ts](../../../lib/agents/gateway/toolDefinitions.ts) | 35 | libraries | MemberAgentToolDefinition:3, MEMBER_AGENT_TOOL_DEFINITIONS:26 |
| [lib/agents/gateway/types.ts](../../../lib/agents/gateway/types.ts) | 172 | libraries | MEMBER_AGENT_TOOL_NAMES:3, MemberAgentToolName:9, AuthenticatedAgentPrincipal:15, AgentGatewayStatus:21, AgentGatewaySource:27, AgentGatewayHandoff:35, AgentGatewayResponse:42, MemberNextStepData:51, MemberTrainingStatusData:61, MemberCourseraProgressData:88, MemberGatewaySnapshot:107, CourseraGatewaySnapshot:144, MemberAgentGatewayReader:160, MemberAgentGateway:166 |
| [lib/agents/knowledge/index.ts](../../../lib/agents/knowledge/index.ts) | 20 | libraries | AgentKnowledgeValidationError:2, DEFAULT_AGENT_KNOWLEDGE_MANIFEST_PATH:3, agentKnowledgeContentSchema:4, agentKnowledgeEntrySchema:5, agentKnowledgeManifestSchema:6, computeKnowledgeContentHash:7, loadAgentKnowledgeManifest:8, sha256Hex:9, validateAgentKnowledgeManifest:10, AgentKnowledgeContent:11, AgentKnowledgeEntry:12, AgentKnowledgeManifest:13, AgentKnowledgeValidationOptions:14, resolveTrustedProgramKnowledge:18, TrustedAgentProgramKnowledge:19 |
| [lib/agents/knowledge/manifest.ts](../../../lib/agents/knowledge/manifest.ts) | 595 | libraries | agentKnowledgeContentSchema:79, agentKnowledgeEntrySchema:85, agentKnowledgeManifestSchema:111, AgentKnowledgeContent:116, AgentKnowledgeEntry:117, AgentKnowledgeManifest:118, AgentKnowledgeValidationOptions:120, AgentKnowledgeValidationError:127, sha256Hex:155, computeCanonicalTextSha256:164, computeKnowledgeContentHash:169, validateAgentKnowledgeManifest:446, DEFAULT_AGENT_KNOWLEDGE_MANIFEST_PATH:553, loadAgentKnowledgeManifest:556 |
| [lib/agents/knowledge/programKnowledge.ts](../../../lib/agents/knowledge/programKnowledge.ts) | 234 | libraries | TrustedAgentProgramKnowledge:35, resolveTrustedProgramKnowledge:97 |
| [lib/ai/aiCoachContext.ts](../../../lib/ai/aiCoachContext.ts) | 472 | ai-voice | AICoachContext:25, AICoachContextOptions:95, getAICoachContext:107, renderCoachContextForPrompt:327 |
| [lib/ai/aiUnavailableResponse.ts](../../../lib/ai/aiUnavailableResponse.ts) | 15 | ai-voice | aiUnconfiguredResponse:5, ifAiUnconfigured:13 |
| [lib/ai/anthropicChat.ts](../../../lib/ai/anthropicChat.ts) | 87 | ai-voice | isAnthropicConfigured:9, claudeChat:25 |
| [lib/ai/atsProviders.ts](../../../lib/ai/atsProviders.ts) | 734 | ai-voice | ATSJob:12, ATSParseResult:25, detectProvider:61, isKnownStructuredApiProvider:78, isLikelyJobDetailUrl:82, getImportWaitForMs:88, extractMeaningfulPageText:121, ContentQualityResult:225, checkContentQuality:232, isFirecrawlConfigured:466, FetchPageError:471, importJobsFromUrl:548, fetchPageText:647, fetchSubJobPageText:686, smartImportJobs:718 |
| [lib/ai/blogAI.ts](../../../lib/ai/blogAI.ts) | 34 | ai-voice | webSearch:5, isWebSearchConfigured:32 |
...
| [lib/ai/elevenLabsDynamicVariablePolicy.ts](../../../lib/ai/elevenLabsDynamicVariablePolicy.ts) | 22 | ai-voice | hasSecretElevenLabsDynamicVariables:9, mayRetryElevenLabsWithoutDynamicVariables:17 |
...
| [lib/ai/parseJob.ts](../../../lib/ai/parseJob.ts) | 416 | ai-voice | ParsedJob:4, ParsedJobListing:18, extractSubJobUrlsFromPageText:133, sanitizeScrapedJobText:158, stripUrlsFromDescription:184, normalizeImportedParsedJob:207, clipJobSourceTextForLLM:252, extractLikelyJobTitleFromScrape:264, buildFallbackParsedJobFromScrape:288, parseJobListingsFromPageText:314, parseJobFromText:353 |
| [lib/ai/parseResumeCoachSuggestions.test.ts](../../../lib/ai/parseResumeCoachSuggestions.test.ts) | 30 | ai-voice |  |
| [lib/ai/parseResumeCoachSuggestions.ts](../../../lib/ai/parseResumeCoachSuggestions.ts) | 100 | ai-voice | ResumeTranscriptTurn:7, ResumeCoachSuggestion:9, normalizeResumeCoachTranscript:15, parseResumeCoachSuggestionsFromTranscript:50 |
| [lib/ai/postProcess.test.ts](../../../lib/ai/postProcess.test.ts) | 39 | ai-voice |  |
| [lib/ai/postProcess.ts](../../../lib/ai/postProcess.ts) | 114 | ai-voice | stripWrappingQuotes:45, normalizeSmartQuotes:60, fixCommonTypos:69, stripMarkdown:82, cleanSpokenLine:95, cleanLongFormPlainText:103, sanitizeAIOutput:112 |
| [lib/ai/prefillFromMemberState.ts](../../../lib/ai/prefillFromMemberState.ts) | 281 | ai-voice | ElevatorPitchPrefill:20, ResumeRewriterPrefill:28, InterviewPracticePrefill:32, prefillElevatorPitch:40, prefillResumeRewriter:63, prefillInterviewPractice:101, CoverLetterPrefill:122, prefillCoverLetter:128, GapAnalyzerPrefill:146, prefillGapAnalyzer:151, LinkedInHeadlinePrefill:168, prefillLinkedInHeadline:174, LinkedInAboutPrefill:188, prefillLinkedInAbout:194, SalaryNegotiationPrefill:212, prefillSalaryNegotiation:218, JobMatchScorerPrefill:229, prefillJobMatchScorer:234, honestNoResumeError:276 |
| [lib/ai/proactiveJobMatcher.ts](../../../lib/ai/proactiveJobMatcher.ts) | 62 | ai-voice | findBestEmployerMatch:34 |
| [lib/ai/proactiveResumeGenerator.ts](../../../lib/ai/proactiveResumeGenerator.ts) | 15 | ai-voice | generateResumeBullet:3 |
| [lib/ai/responseLanguage.ts](../../../lib/ai/responseLanguage.ts) | 37 | ai-voice | AI_RESPONSE_LANGUAGES:1, AIResponseLanguage:3, normalizeAIResponseLanguage:5, aiResponseLanguageInstruction:9, nextInterviewPromptForLanguage:25, firstInterviewPromptForLanguage:32 |
| [lib/ai/resumeCoachDataContract.ts](../../../lib/ai/resumeCoachDataContract.ts) | 9 | ai-voice | RESUME_COACH_INITIAL_TEXT_MAX_CHARS:5, RESUME_COACH_LIVE_DRAFT_MAX_CHARS:6, RESUME_COACH_DATA_USE_NOTICE:8 |
| [lib/ai/resumeCoachHeuristic.ts](../../../lib/ai/resumeCoachHeuristic.ts) | 36 | ai-voice | ResumeCoachHeuristicSuggestion:5, extractResumeCoachSuggestionsFromText:11 |
| [lib/ai/resumeScore/actionVerbs.ts](../../../lib/ai/resumeScore/actionVerbs.ts) | 46 | ai-voice | ACTION_VERBS:4, WEAK_VERBS:43 |
| [lib/ai/resumeScore/index.ts](../../../lib/ai/resumeScore/index.ts) | 15 | ai-voice | scoreStructural:1, parseResume:2, ACTION_VERBS:3, WEAK_VERBS:3, analyzeResume:4, ResumeAnalysisResult:4, inferTargetOccupations:5, TargetOccupation:5, scoreOnetCoverage:6, OnetCoverageResult:6, SkillMatch:6, getMarketSignal:7, scoreMarketCoverage:7, isFirecrawlConfigured:7, MarketSignal:7, MarketCoverageResult:7, MarketKeyword:7, synthesizeAnalysis:8, ResumeBullet:10, ResumeSection:11, ResumeFeatures:12, StructuralScore:13, StructuralSubscore:14 |
| [lib/ai/resumeScore/marketScrape.test.ts](../../../lib/ai/resumeScore/marketScrape.test.ts) | 53 | ai-voice |  |
| [lib/ai/resumeScore/marketScrape.ts](../../../lib/ai/resumeScore/marketScrape.ts) | 243 | ai-voice | MarketKeyword:18, MarketSignal:24, isFirecrawlConfigured:32, getMarketSignal:133, MarketCoverageResult:202, scoreMarketCoverage:214, _resetCacheForTests:241 |
| [lib/ai/resumeScore/occupations.test.ts](../../../lib/ai/resumeScore/occupations.test.ts) | 47 | ai-voice |  |
| [lib/ai/resumeScore/occupations.ts](../../../lib/ai/resumeScore/occupations.ts) | 80 | ai-voice | TargetOccupation:4, inferTargetOccupations:59, _parseOccupationsForTests:80 |
| [lib/ai/resumeScore/onetCoverage.ts](../../../lib/ai/resumeScore/onetCoverage.ts) | 171 | ai-voice | OnetSkillRef:5, SkillMatch:11, OnetCoverageResult:19, scoreOnetCoverage:77, COVERAGE_THRESHOLD:171, TOP_SKILLS_PER_OCC:171 |
| [lib/ai/resumeScore/parse.ts](../../../lib/ai/resumeScore/parse.ts) | 209 | ai-voice | parseResume:146 |
| [lib/ai/resumeScore/score.ts](../../../lib/ai/resumeScore/score.ts) | 147 | ai-voice | ResumeAnalysisResult:8, analyzeResume:54 |
| [lib/ai/resumeScore/structural.test.ts](../../../lib/ai/resumeScore/structural.test.ts) | 123 | ai-voice |  |
| [lib/ai/resumeScore/structural.ts](../../../lib/ai/resumeScore/structural.ts) | 135 | ai-voice | scoreStructural:114, ACTION_VERBS:135, WEAK_VERBS:135 |
| [lib/ai/resumeScore/synthesis.ts](../../../lib/ai/resumeScore/synthesis.ts) | 111 | ai-voice | SynthesisInput:7, synthesizeAnalysis:102, _renderInputForTests:111 |
| [lib/ai/resumeScore/types.ts](../../../lib/ai/resumeScore/types.ts) | 64 | ai-voice | ResumeBullet:1, ResumeSection:17, ResumeFeatures:24, StructuralSubscore:48, StructuralScore:54 |
...
| [lib/ai/voiceSessionBoundary.ts](../../../lib/ai/voiceSessionBoundary.ts) | 31 | ai-voice | VOICE_SESSION_RESPONSE_HEADERS:4, VOICE_SESSION_UNAVAILABLE_MESSAGE:5, VOICE_SESSION_IDENTITY_MESSAGE:7, hasActiveVoiceSessionUser:16 |
| [lib/analytics/aiToolEfficacy.test.ts](../../../lib/analytics/aiToolEfficacy.test.ts) | 301 | administration |  |
...
| [lib/api-docs/catalog.ts](../../../lib/api-docs/catalog.ts) | 7 | libraries | apiDocsCatalog:6, apiDocsOpenApi:7 |
...
| [lib/apply/applyBrowserState.ts](../../../lib/apply/applyBrowserState.ts) | 156 | applications-enrollment | APPLY_STORAGE_KEY:4, APPLY_ACCOUNT_DRAFT_KEY:5, APPLY_DRAFT_TTL_MS:6, EligibilityPanel:7, ApplyDraft:8, SavedEligibility:9, parseApplyDraft:30, parseSavedEligibility:37, readApplyDraft:60, readSavedEligibility:61, writeBrowserValue:62, writeApplyDraft:70, saveEligibilityForNextStep:73, sameEligibility:81, saveSelectedPrograms:84, removeApplyDraft:89, clearApplyBrowserState:92, readSelectedPrograms:104, AccountDraft:130, readAccountDraft:138, writeAccountDraft:153 |
...
| [lib/apply/applyProgramStorage.ts](../../../lib/apply/applyProgramStorage.ts) | 80 | applications-enrollment | APPLY_PROGRAM_SLUG_KEY:2, APPLY_PROGRAM_RANKED_KEY:4, FYP_RESULTS_STORAGE_KEY:7, APPLY_FLOW_DRAFT_KEY:10, ApplyFlowDraftV1:12, CareerQuizSignupPayload:47, getCareerQuizPayloadFromStorage:55 |
| [lib/apply/applyRecoveryHref.ts](../../../lib/apply/applyRecoveryHref.ts) | 14 | applications-enrollment | ApplyRecoveryContext:4, applyRecoveryHref:6 |
...
| [lib/apply/partnerApplyHref.ts](../../../lib/apply/partnerApplyHref.ts) | 20 | applications-enrollment | partnerApplyHref:4, partnerProgramHref:15 |
| [lib/apply/primaryBarrierOptions.ts](../../../lib/apply/primaryBarrierOptions.ts) | 26 | applications-enrollment | DEFAULT_PRIMARY_BARRIER:1, PRIMARY_BARRIER_OPTIONS:6, normalizePrimaryBarriers:18 |
| [lib/apply/publicAssistance.test.ts](../../../lib/apply/publicAssistance.test.ts) | 67 | applications-enrollment |  |
| [lib/apply/publicAssistance.ts](../../../lib/apply/publicAssistance.ts) | 125 | applications-enrollment | PUBLIC_ASSISTANCE_PROGRAM_VALUES:19, PublicAssistanceProgram:20, PUBLIC_ASSISTANCE_PROGRAM_LABELS:23, PublicAssistanceFollowUp:30, EMPTY_PUBLIC_ASSISTANCE_FOLLOW_UP:37, publicAssistanceFollowUpSchema:43, isPublicAssistanceProgram:52, normalizePublicAssistancePrograms:57, normalizePublicAssistanceFollowUp:68, publicAssistanceFollowUpIssue:89, publicAssistanceFollowUpComplete:102, wicOnlyPublicAssistance:116, formatPublicAssistancePrograms:121 |
| [lib/apply/publicEligibilityLead.ts](../../../lib/apply/publicEligibilityLead.ts) | 112 | applications-enrollment | PublicEligibilityLeadInput:21, savePublicEligibilityLead:72, publicEligibilityLeadAuditMetadata:96 |
| [lib/apply/resolveSchoolApply.ts](../../../lib/apply/resolveSchoolApply.ts) | 54 | applications-enrollment | SchoolApplyContext:8, resolveSchoolApply:34 |
| [lib/apply/saveEligibilityScreening.ts](../../../lib/apply/saveEligibilityScreening.ts) | 37 | applications-enrollment | saveEligibilityScreening:6 |
| [lib/apply/schoolCollection.test.ts](../../../lib/apply/schoolCollection.test.ts) | 87 | applications-enrollment |  |
| [lib/apply/schoolCollection.ts](../../../lib/apply/schoolCollection.ts) | 111 | applications-enrollment | SCHOOL_STUDENT_BARRIER:10, SCHOOL_AGE_GROUPS:12, SCHOOL_GRADE_LEVELS:17, SchoolCollectionFields:25, schoolPrimaryBarriers:36, schoolGuardianRequired:40, schoolDetailsComplete:44, SCHOOL_SKIPPED_ADULT_FIELDS:58, isSchoolCollectionSignup:65, schoolProfileBarriers:77, schoolApplicationNotes:84 |
| [lib/apply/usStates.ts](../../../lib/apply/usStates.ts) | 43 | applications-enrollment | UsState:8, US_STATES:10, toStateAbbr:38 |
| [lib/apply/useApplyStickyCtaVisibility.ts](../../../lib/apply/useApplyStickyCtaVisibility.ts) | 149 | applications-enrollment | useApplyStickyCtaVisibility:48 |
...
| [lib/attention/evaluate.test.ts](../../../lib/attention/evaluate.test.ts) | 105 | libraries |  |
| [lib/attention/evaluate.ts](../../../lib/attention/evaluate.ts) | 372 | libraries | MemberAttentionInput:35, RiskLevel:62, AttentionContext:64, MemberAttention:84, OnTrackMember:100, AttentionTotals:108, AttentionQueue:123, riskLevelFromScore:133, sortReasons:142, pickPrimaryReason:146, evaluateMemberAttention:156, urgencyOf:258, compareAttention:287, emptyAttentionQueue:296, buildAttentionQueue:315, selectByReason:364, flaggedMemberIds:370 |
| [lib/attention/loadFacts.ts](../../../lib/attention/loadFacts.ts) | 194 | libraries | ACTIVE_RISK_ALERT_STATUSES:19, AttentionDb:27, previewMessageBody:42, loadAttentionFacts:49 |
| [lib/attention/reasons.ts](../../../lib/attention/reasons.ts) | 181 | libraries | ATTENTION_THRESHOLDS:20, AttentionSeverity:43, ATTENTION_REASONS:50, AttentionReason:70, AttentionReasonMeta:72, ATTENTION_REASON_META:82, ATTENTION_REASON_RANK:155, ATTENTION_ONLY_REASONS:160, attentionReasonLabel:164, attentionReasonDefinition:168, attentionSeverityOf:172, emptyReasonCounts:176 |
| [lib/attention/rules.test.ts](../../../lib/attention/rules.test.ts) | 132 | libraries |  |
| [lib/attention/rules.ts](../../../lib/attention/rules.ts) | 174 | libraries | daysBetween:14, hoursBetween:18, quietDays:30, isQuietFor:44, isNoActivityCritical:57, isNoActivityWarning:67, replyOverdue:83, isCounselorContactOverdue:99, isResumeMissing:110, applicationReason:118, isApplicationStalled:126, isStaleTraining:136, needsComputerSupportFollowUp:143, isMilestoneRecent:154, isNewWithoutCounselor:167 |
| [lib/audit.test.ts](../../../lib/audit.test.ts) | 148 | libraries |  |
| [lib/audit.ts](../../../lib/audit.ts) | 139 | libraries | AUDIT_WRITE_ROUTE:8, resolveActorSnapshot:42, auditLog:93 |
| [lib/audit/log.ts](../../../lib/audit/log.ts) | 170 | libraries | AuditActor:21, AuditObject:26, AuditResult:31, AuditRequestMeta:36, XapiAuditStatement:41, resolveVerbId:63, buildObjectIri:70, buildActivityType:75, buildXapiStatement:80, auditRequestMeta:113, logAuditEvent:128 |
| [lib/audit/rank.test.ts](../../../lib/audit/rank.test.ts) | 79 | libraries |  |
...
| [lib/auth/layoutUserId.ts](../../../lib/auth/layoutUserId.ts) | 19 | identity-tenancy | WAP_USER_ID_HEADER:13, resolveLayoutUserId:15 |
...
| [lib/auth/passwordReset.ts](../../../lib/auth/passwordReset.ts) | 255 | identity-tenancy | PasswordResetSendResult:13, sendPasswordResetEmail:130 |
...
| [lib/auth/postLoginRedirect.test.ts](../../../lib/auth/postLoginRedirect.test.ts) | 57 | identity-tenancy |  |
| [lib/auth/postLoginRedirect.ts](../../../lib/auth/postLoginRedirect.ts) | 53 | identity-tenancy | resolveRoleAwarePostLoginRedirect:21, normalizePostLoginRedirect:40 |
...
| [lib/auth/supabaseAdminUsers.ts](../../../lib/auth/supabaseAdminUsers.ts) | 27 | identity-tenancy | SupabaseAuthUserLookupOptions:3, findSupabaseAuthUserByEmail:8 |
| [lib/auth/supabaseAuthCookie.test.ts](../../../lib/auth/supabaseAuthCookie.test.ts) | 63 | identity-tenancy |  |
| [lib/auth/supabaseAuthCookie.ts](../../../lib/auth/supabaseAuthCookie.ts) | 52 | identity-tenancy | CookieNameValue:12, CookieListLike:14, isSupabaseAuthTokenCookieName:19, isSupabasePkceCookieName:24, hasSupabaseAuthCookies:36, shouldTalkToGoTrue:47 |
| [lib/auth/tenantApiNavigation.test.ts](../../../lib/auth/tenantApiNavigation.test.ts) | 25 | identity-tenancy |  |
| [lib/auth/tenantApiNavigation.ts](../../../lib/auth/tenantApiNavigation.ts) | 18 | identity-tenancy | isUnauthenticatedBrowserNavigationApiPath:12 |
| [lib/billing/packetAccess.ts](../../../lib/billing/packetAccess.ts) | 125 | partners-funding | resolveProgramTitle:9, BillingPacketSummary:12, serializeBillingPacket:32, PacketViewer:54, LoadedPacket:56, LoadPacketResult:62, loadPacketForViewer:73, listPacketsForMember:107, resolveAssignedCounselorContact:117 |
| [lib/billing/packetDefaults.ts](../../../lib/billing/packetDefaults.ts) | 68 | partners-funding | ProgramPricing:9, CatalogPricingRow:18, resolveProgramPricing:25, buildDefaultLineItems:46 |
| [lib/billing/packetDocument.ts](../../../lib/billing/packetDocument.ts) | 39 | partners-funding | resolveProgramTitle:8, packetToDocumentInput:13 |
| [lib/billing/packetNumber.ts](../../../lib/billing/packetNumber.ts) | 28 | partners-funding | nextPacketNumber:8, formatPacketNumber:22, isUniqueViolation:26 |
| [lib/billing/packetPdf.test.ts](../../../lib/billing/packetPdf.test.ts) | 137 | partners-funding |  |
| [lib/billing/packetPdf.ts](../../../lib/billing/packetPdf.ts) | 525 | partners-funding | PacketDocumentInput:13, PacketDocKind:36, sanitizePdfText:64, loadLetterheadLogo:71, renderJ5InvoicePdf:328, renderJ6CoverLetterPdf:447, renderPacketBundlePdf:492, PacketDownloadKind:508, parsePacketDownloadKind:510, renderPacketDocument:516, packetDocumentFilename:521 |
| [lib/billing/packetSchema.ts](../../../lib/billing/packetSchema.ts) | 69 | partners-funding | PacketLineItem:4, createPacketSchema:20, CreatePacketInput:44, roundMoney:47, sumLineItems:51, parseLineItems:56 |
| [lib/billing/packetText.test.ts](../../../lib/billing/packetText.test.ts) | 112 | partners-funding |  |
| [lib/billing/packetText.ts](../../../lib/billing/packetText.ts) | 79 | partners-funding | formatMoney:7, formatLongDate:13, totalContactHours:18, allocateAmount:28, defaultCoverLetterBody:51, isoDatePlusDays:76 |
| [lib/billing/providerIdentity.ts](../../../lib/billing/providerIdentity.ts) | 60 | partners-funding | TrainingProviderIdentity:8, DefaultSigner:19, getTrainingProviderIdentity:26, getDefaultSigner:40, getPacketNumberPrefix:49, getDefaultBillTo:54 |
...
| [lib/cache.test.ts](../../../lib/cache.test.ts) | 181 | libraries |  |
| [lib/cache.ts](../../../lib/cache.ts) | 115 | libraries | getCache:27, setCache:46, deleteCache:60, getCacheOrFetch:73, invalidateCache:91 |
| [lib/career/autoMatch.test.ts](../../../lib/career/autoMatch.test.ts) | 461 | libraries |  |
| [lib/career/autoMatch.ts](../../../lib/career/autoMatch.ts) | 505 | libraries | OccupationForMatch:30, AutoMatchResult:51, tokenize:132, buildOccupationTokens:150, buildProgramKeywords:171, scoreToRecommendationType:281, inferExperienceBand:287, MIN_INCLUDED_SCORE:399, TOP_N:400, rankPrograms:484, scoreProgram:500 |
| [lib/career/autoMatchLlmRefine.ts](../../../lib/career/autoMatchLlmRefine.ts) | 154 | libraries | RefinedMatch:20, refineMatchesWithLlm:105 |
...
| [lib/contact/nativeFormPost.ts](../../../lib/contact/nativeFormPost.ts) | 31 | libraries | CONTACT_FORM_THANKS_PATH:11, CONTACT_FORM_ERROR_PATH:12, isNativeFormPost:16, contactFormDataToBody:22 |
...
| [lib/content/checkpoints/index.ts](../../../lib/content/checkpoints/index.ts) | 28 | public-experience | ProgramCheckpointPack:7, SkillCheckpoint:7, CourseCheckpointSet:7, ALL_CHECKPOINT_PACKS:9, getPackByProgram:16, getCheckpointById:20 |
| [lib/content/checkpoints/itInfrastructure.ts](../../../lib/content/checkpoints/itInfrastructure.ts) | 2124 | public-experience | IT_INFRASTRUCTURE_PACKS:13 |
| [lib/content/checkpoints/tradesAndHealth.ts](../../../lib/content/checkpoints/tradesAndHealth.ts) | 1726 | public-experience | TRADES_AND_HEALTH_PACKS:14 |
| [lib/content/checkpoints/types.ts](../../../lib/content/checkpoints/types.ts) | 59 | public-experience | CheckpointOption:18, SkillCheckpoint:23, CourseCheckpointSet:46, ProgramCheckpointPack:53 |
| [lib/content/courseDelivery.test.ts](../../../lib/content/courseDelivery.test.ts) | 27 | public-experience |  |
| [lib/content/courseDelivery.ts](../../../lib/content/courseDelivery.ts) | 18 | public-experience | CourseDeliveryLike:3, isWorkforceApCourse:8, workforceApCourseHref:12, digitalLiteracyFirstModuleHref:16 |
...
| [lib/content/coursera/curatedCollectionsCsv.test.ts](../../../lib/content/coursera/curatedCollectionsCsv.test.ts) | 100 | learning-coursera |  |
| [lib/content/coursera/curatedCollectionsCsv.ts](../../../lib/content/coursera/curatedCollectionsCsv.ts) | 289 | learning-coursera | CuratedCourse:16, CuratedCollection:28, CuratedCollectionsSource:37, CuratedCollectionsExport:49, CURATED_COURSE_ID:63, parseCsv:77, parseExportFileName:133, parseCuratedCollectionsCsv:163, GENERATED_MODULE_PATH:249, serializeCuratedCollectionsModule:252 |
| [lib/content/coursera/learningPaths.test.ts](../../../lib/content/coursera/learningPaths.test.ts) | 120 | learning-coursera |  |
| [lib/content/coursera/learningPaths.ts](../../../lib/content/coursera/learningPaths.ts) | 334 | learning-coursera | CourseraLearningPath:33, COURSERA_LEARNING_PATHS:55, LEARNING_PATH_CONTENT_TYPES:208, isLearningPathContentType:216, normalizeLearningPathName:222, LearningPathIndex:226, buildLearningPathIndex:232, addLearningPathToIndex:244, cloneLearningPathIndex:256, findLearningPathById:265, findLearningPathByCollection:274, learningPathProgramSlug:288, COURSERA_UMBRELLA_PROGRAM_ID:298, isUmbrellaB4BProgramId:300, isProgramLevelCourseraId:318, KNOWN_LEARNING_PATH_IDS:325, KNOWN_LEARNING_PATH_COLLECTION_IDS:330 |
...
| [lib/content/memberResources.ts](../../../lib/content/memberResources.ts) | 74 | public-experience | ResourceCategory:1, ResourceStage:8, MemberResource:13, MemberResourcesResult:25, MemberResourcesOptions:30, getMemberResourcesResult:36, getMemberResources:56, CATEGORIES:62, STAGES:70 |
| [lib/content/pathwayStepDisplay.test.ts](../../../lib/content/pathwayStepDisplay.test.ts) | 28 | public-experience |  |
| [lib/content/pathwayStepDisplay.ts](../../../lib/content/pathwayStepDisplay.ts) | 93 | public-experience | PathwayMilestoneStatus:3, PathwayMilestone:5, iconForPathwayStep:17, buildPathwayMilestones:34 |
| [lib/content/programCatalogParity.test.ts](../../../lib/content/programCatalogParity.test.ts) | 77 | public-experience |  |
| [lib/content/programCatalogSearch.ts](../../../lib/content/programCatalogSearch.ts) | 34 | public-experience | buildProgramSearchHaystack:5, programMatchesSearchQuery:28 |
...
| [lib/content/programs.ts](../../../lib/content/programs.ts) | 698 | public-experience | PROGRAM_SLUG_ALIASES:19, FUNDING_SOURCES:42, FundingSource:49, LanguageSupportLevel:51, LanguageSupport:53, formatFundingSourceLabel:60, FUNDING_COLORS:65, ProgramCourse:80, Program:114, getDiscoveredProgram:169, getProgramDisplayTitle:196, getProgramDisplayPartner:204, PROGRAM_CATEGORY_COLORS:211, PROGRAMS:402, WORKFORCEAP_PROGRAM_CATALOG_SIZE:462, PROGRAM_AXIS_MAP:469, RadarAxis:539, RADAR_AXES:540, ProgramRecommendation:542, recommendProgramsForGaps:558, PROGRAM_TITLES:612, LEGACY_PROGRAM_TITLE_VALUES:629, SUPPORTED_PROGRAM_STORAGE_VALUES:642, CURRICULUM_MIGRATION_PENDING_CODE:650, CURRICULUM_MIGRATION_PENDING_MESSAGE:651, isCurriculumMigrationPending:660, getProgramByInterestValue:666, getProgramBySlug:686, getAllPrograms:691, invalidateProgramCache:696 |
...
| [lib/counselor/commandCenter.ts](../../../lib/counselor/commandCenter.ts) | 219 | member-counselor | CommandCenterRow:24, NeedsReplyRow:30, AtRiskRow:37, InterviewingRow:46, CommandCenter:51, getCounselorCommandCenter:73 |
...
| [lib/counselor/inboxZero.query.test.ts](../../../lib/counselor/inboxZero.query.test.ts) | 102 | member-counselor |  |
| [lib/counselor/inboxZero.ts](../../../lib/counselor/inboxZero.ts) | 84 | member-counselor | InboxZeroContext:20, InboxZeroQueue:20, InboxZeroRow:20, DOC_MISSING_DAYS:24, APPLICATION_STALLED_DAYS:25, LAST_CONTACT_DAYS:26, INBOX_ZERO_DISMISS_ACTION:28, INBOX_ZERO_CONTACTED_ACTION:29, INBOX_ZERO_REASSIGN_ACTION:30, INBOX_ZERO_FOLLOW_UP_ACTION:31, InboxZeroFlagType:35, INBOX_FLAG_LABELS:37, getInboxZeroQueue:72 |
...
| [lib/counselor/rosterStats.ts](../../../lib/counselor/rosterStats.ts) | 97 | member-counselor | ROSTER_STAT_LOOKBACK_DAYS:18, CounselorRosterStatKey:20, CounselorRosterStat:22, buildCounselorRosterStats:45 |
...
| [lib/counselor/triageFlags.ts](../../../lib/counselor/triageFlags.ts) | 52 | member-counselor | emptyTriageQueue:22, FLAG_PRIORITY:23, TriageContext:24, TriagePriority:25, TriageQueue:26, TriageRow:27, NO_ACTIVITY_DAYS:30, SLA_BREACH_HOURS:31, SLA_WARNING_HOURS:32, STALE_TRAINING_WINDOW_DAYS:33, MILESTONE_WINDOW_DAYS:34, TriageFlagType:36, FLAG_LABELS:38, getTriageQueue:47 |
| [lib/counselor/workQueue.ts](../../../lib/counselor/workQueue.ts) | 56 | member-counselor | WorkQueueContext:15, WorkQueueRow:15, QUEUE_THRESHOLD_HOURS:17, getCounselorWorkQueue:26, getCounselorWorkQueueContext:34, formatTimeWaiting:42, previewMessageBody:52 |
...
| [lib/coursera/b4bSync.test.ts](../../../lib/coursera/b4bSync.test.ts) | 389 | learning-coursera |  |
| [lib/coursera/b4bSync.ts](../../../lib/coursera/b4bSync.ts) | 1116 | learning-coursera | nextEnrollmentReportStart:35, B4BEnrollmentReport:58, RawB4BEnrollmentReport:80, B4BUnknownCourseDetail:84, B4BProgressRowAccounting:94, accountB4BProgressRow:117, B4BSyncResult:179, normalizeB4BEnrollmentReport:220, planB4BRowWrite:247, selectCanonicalB4BMapping:382, B4BProgressInput:415, B4BSignalSources:429, mergeB4BProgressSignals:465, ExistingCourseProgress:497, MergedCourseProgress:503, computeCourseProgressUpdate:534, EnrolledProgramSyncDecision:606, decideEnrolledProgramSync:628, syncCourseraB4BEnrollmentReports:650 |
| [lib/coursera/canonicalMapping.ts](../../../lib/coursera/canonicalMapping.ts) | 195 | learning-coursera | CanonicalMappingHit:23, CanonicalMappingIndex:33, emptyCanonicalMappingIndex:38, courseraCourseIdLookupVariants:64, indexCanonicalMappingRows:84, loadCanonicalMappingsForCourseraIds:119, findCanonicalMappingForCourseraCourse:152 |
| [lib/coursera/catalogBackfill.test.ts](../../../lib/coursera/catalogBackfill.test.ts) | 221 | learning-coursera |  |
| [lib/coursera/client.ts](../../../lib/coursera/client.ts) | 145 | learning-coursera | CourseraLearnerSkillsetProgress:6, fetchCourseraLearnerSkillsetProgress:87 |
| [lib/coursera/config.test.ts](../../../lib/coursera/config.test.ts) | 172 | learning-coursera |  |
| [lib/coursera/config.ts](../../../lib/coursera/config.ts) | 11 | learning-coursera | buildCourseraLaunchUrl:4, getCourseraConfig:5, getCourseraReadiness:6, getCourseraSkillsetSlugOverrides:7, resolveCourseraPublicProgramUrl:8, resolveCourseraProgramId:9, resolveCourseraSkillsetIds:10 |
...
| [lib/coursera/csvImport.server.ts](../../../lib/coursera/csvImport.server.ts) | 1351 | learning-coursera | ingestCourseActivityRows:320, ingestLearningPathActivityRows:736, CourseraRawProgressAttachment:831, lockCourseraIdentityForAttachment:842, attachRawCourseraProgressToUser:877, backfillUserIdForCourseraEmail:988, backfillAllOrphanedCourseraProgress:1043, CourseraProgressPromotionResult:1122, promoteCsvProgressToCanonical:1168 |
| [lib/coursera/csvImport.test.ts](../../../lib/coursera/csvImport.test.ts) | 258 | learning-coursera |  |
...
| [lib/coursera/curriculumMapping.ts](../../../lib/coursera/curriculumMapping.ts) | 355 | learning-coursera | CurriculumMappingRow:24, CurriculumMappingIndex:32, emptyCurriculumMappingIndex:37, isMissingCurriculumMappingTableError:50, buildCurriculumMappingIndex:59, loadCurriculumMappingsForCourseraIds:115, resolveCurriculumMappingsForCourse:151, legacyCandidatesForProviderCourse:191, resolveProviderCourseMappings:257 |
...
| [lib/coursera/enrollmentReportFields.ts](../../../lib/coursera/enrollmentReportFields.ts) | 53 | learning-coursera | enrollmentActivityMilliseconds:2, normalizeCourseraPageOffset:17, nextEnrollmentReportStart:25 |
| [lib/coursera/isLikelyTestAccount.test.ts](../../../lib/coursera/isLikelyTestAccount.test.ts) | 116 | learning-coursera |  |
| [lib/coursera/launchRoute.test.ts](../../../lib/coursera/launchRoute.test.ts) | 30 | learning-coursera |  |
| [lib/coursera/launchRouteCore.test.ts](../../../lib/coursera/launchRouteCore.test.ts) | 431 | learning-coursera |  |
| [lib/coursera/launchRouteCore.ts](../../../lib/coursera/launchRouteCore.ts) | 318 | learning-coursera | CourseraLaunchUser:1, CourseraLaunchDependencies:39, createCourseraLaunchHandler:100 |
| [lib/coursera/learnerProgress.test.ts](../../../lib/coursera/learnerProgress.test.ts) | 509 | learning-coursera |  |
| [lib/coursera/learnerProgress.ts](../../../lib/coursera/learnerProgress.ts) | 384 | learning-coursera | LearnerProgressEntry:55, LearnerProgressByContent:65, _resetLearnerProgressCachesForTesting:112, _getLearnerCacheEntryForTesting:117, invalidateLearnerProgressCacheForEmail:131, fetchLearnerProgressFromB4B:218, getLearnerProgressLastActivity:335, filterRecognizedCourseraCourseIds:353, averageProgramProgressFromB4B:369 |
| [lib/coursera/learningPathAttribution.test.ts](../../../lib/coursera/learningPathAttribution.test.ts) | 203 | learning-coursera |  |
| [lib/coursera/learningPathAttribution.ts](../../../lib/coursera/learningPathAttribution.ts) | 146 | learning-coursera | LearningPathReportLike:33, LearningPathMatch:41, CollectionResolution:49, matchLearningPathReport:75, withLearnedCollections:94, resolveReportCollection:118, rawProgressProgramSlug:138 |
| [lib/coursera/legacyRawProgressAdoption.server.ts](../../../lib/coursera/legacyRawProgressAdoption.server.ts) | 424 | learning-coursera | lockLegacyRawCourseraEmails:73, adoptLegacyRawCourseProgressRows:154, adoptLegacyRawBadgeProgressRows:292 |
| [lib/coursera/linkHealth.ts](../../../lib/coursera/linkHealth.ts) | 175 | learning-coursera | CourseraLinkHealth:11, auditCourseraLinkHealth:65 |
| [lib/coursera/mapIdentityAndProgress.server.ts](../../../lib/coursera/mapIdentityAndProgress.server.ts) | 178 | learning-coursera | MapCourseraIdentityAndProgressArgs:15, mapCourseraIdentityAndProgressInTransaction:50, mapCourseraIdentityAndProgress:150 |
| [lib/coursera/memberSkillsetProgress.ts](../../../lib/coursera/memberSkillsetProgress.ts) | 40 | learning-coursera | MemberSkillsetProgressRow:6, loadMemberSkillsetProgress:21 |
| [lib/coursera/mergeCourseraEmailResolutions.ts](../../../lib/coursera/mergeCourseraEmailResolutions.ts) | 26 | learning-coursera | mergeCourseraEmailResolutions:5 |
| [lib/coursera/milestones.test.ts](../../../lib/coursera/milestones.test.ts) | 132 | learning-coursera |  |
| [lib/coursera/milestones.ts](../../../lib/coursera/milestones.ts) | 132 | learning-coursera | MilestoneKey:3, courseCompletionMilestoneRef:18, TrainingMilestoneState:28, TrainingMilestoneTruth:33, hasValidatedTrainingStarted:42, deriveTrainingMilestoneTruth:61, detectMilestoneTransitions:87 |
...
| [lib/coursera/programCourseList.ts](../../../lib/coursera/programCourseList.ts) | 439 | learning-coursera | COURSERA_UMBRELLA_PROGRAM_ID:18, isProgramLevelCourseraId:18, isUmbrellaB4BProgramId:18, CourseraContentFact:35, CourseraContentCatalogResult:42, ProgramCatalogHealth:46, ValidatedProgramCourseList:58, ValidatedProgramCatalogEntry:66, ProgramCourseListDependencies:71, loadValidatedProgramCourses:334, loadValidatedProgramCatalog:380 |
| [lib/coursera/progressMiscount.test.ts](../../../lib/coursera/progressMiscount.test.ts) | 312 | learning-coursera |  |
| [lib/coursera/progressPromotion.test.ts](../../../lib/coursera/progressPromotion.test.ts) | 47 | learning-coursera |  |
| [lib/coursera/progressPromotion.ts](../../../lib/coursera/progressPromotion.ts) | 108 | learning-coursera | CanonicalCourseProgressMapping:11, CourseraProgressPromotionRow:16, PlannedCourseraProgressPromotion:27, isLearningPathProgressRow:46, parseCourseraGradeScore:53, planCourseraProgressPromotion:67 |
| [lib/coursera/progressQueries.ts](../../../lib/coursera/progressQueries.ts) | 1106 | learning-coursera | isLikelyTestAccount:11, BadgeProgressSummary:13, loadBadgeProgressSummary:40, UnmatchedLearner:112, LoadUnmatchedLearnersOptions:136, loadUnmatchedLearners:185, countHiddenTestAccountUnmatchedLearners:386, countUnmatchedLearners:434, LearnerCourseRow:475, LearnerBadgeRow:493, LearnerProgressDetail:508, loadLearnerProgressByUserId:522, isLearningPathCourseRow:640, partitionLearnerCourseRows:644, loadLearnerProgressByExternalEmail:707, UnmatchedXapiEventRow:803, loadUnmatchedXapiEventsByExternalEmail:836, countUnmatchedXapiEventsByExternalEmail:884, loadUnmatchedXapiEventsByExternalEmailPaginated:919, SuggestedUserMatch:964, suggestUserMatchesForExternalEmail:999 |
| [lib/coursera/progressReconciliation.test.ts](../../../lib/coursera/progressReconciliation.test.ts) | 147 | learning-coursera |  |
| [lib/coursera/progressReconciliation.ts](../../../lib/coursera/progressReconciliation.ts) | 168 | learning-coursera | CourseProgressReconcileRow:4, LocalCourseProgressFact:22, B4BCourseProgressFact:29, ProgramProgressReconciliation:34, reconcileProgramProgress:74 |
| [lib/coursera/progressTileSummary.ts](../../../lib/coursera/progressTileSummary.ts) | 111 | learning-coursera | ProgramCourseProgressSummary:14, isCourseraDeliveredCourse:24, isWorkforceApLabRow:36, describeCourseDenominator:46, summarizeProgramCourseProgress:57, learningPathPercent:92, formatProgramCoursesNote:103, formatLearningPathLine:107 |
...
| [lib/coursera/validateApprovedCurriculumTrack.test.ts](../../../lib/coursera/validateApprovedCurriculumTrack.test.ts) | 195 | learning-coursera |  |
| [lib/coursera/validateApprovedCurriculumTrack.ts](../../../lib/coursera/validateApprovedCurriculumTrack.ts) | 262 | learning-coursera | ProviderContent:7, ProviderTrack:14, ApprovedCurriculumTrackValidation:19, ApprovedCurriculumCatalogValidation:33, drainB4BValidationPages:61, validateApprovedCurriculumCatalog:123, validateApprovedCurriculumTrack:205 |
| [lib/coursera/webhookAuth.test.ts](../../../lib/coursera/webhookAuth.test.ts) | 177 | learning-coursera |  |
...
| [lib/cron/cronSecretPolicy.test.ts](../../../lib/cron/cronSecretPolicy.test.ts) | 48 | communications |  |
| [lib/cron/cronSecretPolicy.ts](../../../lib/cron/cronSecretPolicy.ts) | 47 | communications | CRON_ALLOW_MISSING_SECRET_ENV:10, CronSecretBootReason:12, CronSecretBootDecision:19, decideCronSecretBoot:21, decideCronSecretBootFromEnv:34, CRON_SECRET_BOOT_MESSAGE:43 |
...
| [lib/cron/withCronLogging.ts](../../../lib/cron/withCronLogging.ts) | 138 | communications | withCronLogging:43 |
...
| [lib/elevenlabs/agentRegistry.ts](../../../lib/elevenlabs/agentRegistry.ts) | 397 | ai-voice | ELEVENLABS_AGENT_KEYS:15, ElevenLabsAgentKey:27, ElevenLabsAgentId:29, ElevenLabsAgentAudience:31, ElevenLabsAgentExposure:38, ElevenLabsAgentEnvironmentKey:40, ElevenLabsAgentRegistryEntry:72, LILLEY_STUDENT_COACH_AGENT_ID:95, RESUME_COACH_REVIEWED_AGENT_ID:98, ELEVENLABS_AGENT_REGISTRY:110, ElevenLabsAgentResolutionFailureReason:283, ElevenLabsAgentResolution:288, ElevenLabsAgentEnvironment:307, isElevenLabsAgentId:312, resolveElevenLabsAgent:347, getElevenLabsAgentIdFromRegistry:385, environmentKeyForElevenLabsAgent:393 |
| [lib/email.ts](../../../lib/email.ts) | 2947 | communications | getAdminAlertRecipients:101, getAssessmentResultRecipients:118, getResend:128, getVoiceCoachTranscriptRecipients:157, sendVoiceCoachTranscriptEmail:175, sendVoiceCoachArtifactEmail:254, sendVoiceInterviewTranscriptEmail:323, sendElevatorSpeechEmail:398, sendCounselorAssignedEmail:465, sendEnrollmentConfirmationEmail:510, getAtRiskDigestRecipients:560, getCourseraUnmatchedActorAlertRecipients:575, sendCourseraUnmatchedActorAlertEmail:587, sendOnboardingStallsDigestEmail:639, sendApplicationAcceptedEmail:696, sendApplicationRejectedEmail:741, sendPreScreeningReadyEmail:776, sendNewApplicationAdminEmail:823, sendCourseEnrolledEmail:862, sendCourseKickoffEmail:903, sendCourseAccountabilityEmail:944, sendCertCelebrationEmail:984, preparePlacementSurveyEmail:1036, sendPreparedPlacementSurveyEmail:1073, sendPlacementSurveyEmail:1094, sendPlacementSurveyEscalationEmail:1101, sendCourseCompletedEmail:1141, sendMilestoneCascadeEmail:1184, sendWeeklyRecapEmail:1233, sendInvitationEmail:1287, sendPartnerReferralInviteEmail:1341, sendInvitationAcceptedEmail:1384, sendInactiveNudgeEmail:1424, sendJobAlertDigestEmail:1463, sendJobSubmittedEmail:1498, sendJobApprovedEmail:1539, sendJobRejectedEmail:1585, sendNewJobApplicationEmail:1628, sendAIMatchSuggestionEmail:1664, sendMatchActionEmail:1701, sendApplicationConfirmationEmail:1708, sendSchoolEnrollmentParentAckEmail:1751, sendSchoolEnrollmentPartnerAckEmail:1794, sendEligibilityScreeningConfirmationEmail:1840, sendEligibilityScreeningAdminEmail:1878, sendApplicantFollowupEmail:1918, sendAdminPendingApplicantsEmail:1953, sendApplicantChaseEmail:1990, sendApplicantAgingDigestEmail:2026, sendEmployerPendingApplicantsEmail:2068, sendAdminStaleApplicantsDigestEmail:2103, sendEmployerJobExpiryEmail:2135, sendAdminWeeklyRecapEmail:2168, sendWioaReportEmail:2205, sendPartnerWeeklyDigestEmail:2255, sendEmployerWelcomeEmail:2296, sendEmployerVerificationEmail:2334, sendEmployerSignupAdminAlertEmail:2371, sendEmployerApprovedEmail:2406, sendEmployerRejectedEmail:2440, sendAssessmentResetNotificationEmail:2475, sendInterviewPrepBundleEmail:2514, sendInterviewPrepReminderEmail:2578, sendInterviewDebriefPromptEmail:2616, sendCounselorAtRiskAlertEmail:2656, sendMemberCheckInEmail:2717, sendMemberComeBackEmail:2756, sendMemberStuckEmail:2799, sendInterviewPrepLink:2840, ELIGIBILITY_SOFT_DEADLINE_COPY:2887, sendEligibilityLink:2895 |
| [lib/email/adminRecipients.test.ts](../../../lib/email/adminRecipients.test.ts) | 34 | communications |  |
| [lib/email/bulkCronGuard.test.ts](../../../lib/email/bulkCronGuard.test.ts) | 138 | communications |  |
...
| [lib/email/templateKeys.ts](../../../lib/email/templateKeys.ts) | 71 | communications | EMAIL_TEMPLATE_KEYS:14, EmailTemplateKey:53, UNTYPED_EMAIL_TEMPLATE_KEY:56, resolveEmailTemplateKey:63 |
...
| [lib/email/webhookSignature.ts](../../../lib/email/webhookSignature.ts) | 89 | communications | SVIX_TIMESTAMP_TOLERANCE_SECONDS:13, SvixSignatureInput:15, SvixVerification:25, signSvixPayload:50, verifySvixSignature:56 |
...
| [lib/employer/applicationStatus.test.ts](../../../lib/employer/applicationStatus.test.ts) | 18 | jobs-employers |  |
| [lib/employer/applicationStatus.ts](../../../lib/employer/applicationStatus.ts) | 18 | jobs-employers | canTransitionJobApplicationStatus:12 |
| [lib/employer/applicationStatusEffects.ts](../../../lib/employer/applicationStatusEffects.ts) | 141 | jobs-employers | notifyAndRecordPlacement:40 |
| [lib/employer/bulkJobInsert.ts](../../../lib/employer/bulkJobInsert.ts) | 36 | jobs-employers | insertEmployerJobsBatch:17 |
| [lib/employer/employerApplicationsListQuery.ts](../../../lib/employer/employerApplicationsListQuery.ts) | 35 | jobs-employers | EmployerApplicationsSort:12, parseEmployerApplicationStatusFilter:14, parseEmployerApplicationsSort:19, employerApplicationsListHref:23 |
| [lib/employer/employerJobFormFlash.ts](../../../lib/employer/employerJobFormFlash.ts) | 2 | jobs-employers | EMPLOYER_JOB_SUBMIT_REVIEW_DRAFT_FLASH:2 |
| [lib/employer/employerJobsBulk.ts](../../../lib/employer/employerJobsBulk.ts) | 2 | jobs-employers | EMPLOYER_JOB_BULK_MAX_IDS_PER_REQUEST:2 |
...
| [lib/employer/jobStatusDisplay.ts](../../../lib/employer/jobStatusDisplay.ts) | 39 | jobs-employers | employerJobStatusLabel:13, employerJobPortalStatusLabel:17, employerJobPortalBadgeVariant:25, employerJobStatusBadgeVariant:33 |
| [lib/employer/matchScoreDisplay.test.ts](../../../lib/employer/matchScoreDisplay.test.ts) | 12 | jobs-employers |  |
| [lib/employer/matchScoreDisplay.ts](../../../lib/employer/matchScoreDisplay.ts) | 17 | jobs-employers | matchScoreAsPercent:11 |
...
| [lib/enroll/resolveEnrollmentPartner.ts](../../../lib/enroll/resolveEnrollmentPartner.ts) | 164 | applications-enrollment | enrollmentPathForSlug:6, enrollmentPathSegment:6, EnrollmentProgramCard:8, EnrollmentPageModel:21, EnrollmentPartnerLink:36, resolveEnrollmentPartner:58, enrollPageCopyIsStakeSafe:120, humanizeEnrollmentSchoolKey:125, listPublicEnrollmentPartners:135 |
...
| [lib/events/names.ts](../../../lib/events/names.ts) | 162 | libraries | EVENT_NAMES:5, EventName:99, isEventName:101, LEGACY_EVENT_NAME_ALIASES:112, LegacyEventNameAlias:119, isLegacyEventNameAlias:125, canonicalEventName:133, eventNameReadCandidates:144, CLIENT_EVENT_NAMES:153, ClientEventName:162 |
...
| [lib/feature-flags/isFlagEnabledForUser.ts](../../../lib/feature-flags/isFlagEnabledForUser.ts) | 46 | libraries | GUIDED_TOURS_V2_FLAG:19, isFlagEnabledForUser:36 |
| [lib/feature-flags/publicApi.test.ts](../../../lib/feature-flags/publicApi.test.ts) | 56 | libraries |  |
...
| [lib/i18n/pickRootClientMessages.ts](../../../lib/i18n/pickRootClientMessages.ts) | 214 | public-experience | ROOT_CHROME_NAMESPACES:6, ROOT_MARKETING_CLIENT_KEYS:12, PORTAL_CLIENT_NAMESPACES:15, WIOA_CLIENT_NAMESPACES:47, ADMIN_DASHBOARD_CLIENT_KEYS:55, ClientMessageSlice:67, pickRootClientMessages:103, pickPortalClientMessages:107, pickAdminClientMessages:111, pickApplyClientMessages:115, pickAuthClientMessages:119, pickWioaClientMessages:123, pickClientMessageSlice:127, clientMessagesBytes:174, pickLegacyFatRootClientMessages:179 |
...
| [lib/invitations/inviteUiCopy.ts](../../../lib/invitations/inviteUiCopy.ts) | 29 | libraries | InvitationErrorKey:16, invitationErrorKey:19, invitationRoleKey:26 |
| [lib/invitations/loginCode.test.ts](../../../lib/invitations/loginCode.test.ts) | 16 | libraries |  |
| [lib/invitations/loginCode.ts](../../../lib/invitations/loginCode.ts) | 25 | libraries | LOGIN_CODE_LENGTH:12, loginCodeFromToken:14, normalizeLoginCode:20 |
| [lib/invitations/resolveInviteAcceptOrg.test.ts](../../../lib/invitations/resolveInviteAcceptOrg.test.ts) | 53 | libraries |  |
| [lib/invitations/resolveInviteAcceptOrg.ts](../../../lib/invitations/resolveInviteAcceptOrg.ts) | 42 | libraries | chooseInviteAcceptOrganizationId:7, buildInviteAcceptExistingUserUpdate:20 |
| [lib/jobApplications/constants.ts](../../../lib/jobApplications/constants.ts) | 35 | libraries | JOB_APPLICATION_STATUS:3, JobApplicationStatus:13, JobApplicationStatusMembers:15, JOB_APPLICATION_SOURCE:21, JobApplicationSource:28, JobApplicationSourceMembers:30 |
...
| [lib/marketing/heroImage.ts](../../../lib/marketing/heroImage.ts) | 17 | public-experience | MARKETING_FULL_BLEED_HERO_SIZES:16 |
...
| [lib/marketing/publicUiRouteContract.test.ts](../../../lib/marketing/publicUiRouteContract.test.ts) | 33 | public-experience |  |
...
| [lib/member/atRiskScoring.test.ts](../../../lib/member/atRiskScoring.test.ts) | 158 | member-counselor |  |
| [lib/member/atRiskScoring.ts](../../../lib/member/atRiskScoring.ts) | 558 | member-counselor | AtRiskFactor:12, AtRiskScore:18, THRESHOLDS:48, getRiskLevel:55, calculateAtRiskScore:64, buildRecommendedAction:222, AtRiskTier:248, ClassifyMemberInput:250, ClassifyMemberResult:266, classifyMember:285, buildMemberClassificationInput:371, AT_RISK_SCORING_POPULATION_WHERE:457, calculateAllAtRiskScores:465, persistAtRiskAlert:495, loadPersistedAtRiskScores:536 |
| [lib/member/atRiskStatuses.ts](../../../lib/member/atRiskStatuses.ts) | 7 | member-counselor | ACTIVE_AT_RISK_STATUSES:7 |
...
| [lib/member/exportData.ts](../../../lib/member/exportData.ts) | 641 | member-counselor | buildMemberExport:7 |
...
| [lib/member/jobPipelineDisplay.test.ts](../../../lib/member/jobPipelineDisplay.test.ts) | 66 | member-counselor |  |
| [lib/member/jobPipelineDisplay.ts](../../../lib/member/jobPipelineDisplay.ts) | 52 | member-counselor | JOBS_EMPTY_RECOMMENDATIONS:5, JOBS_BOARD_EMPTY:17, ACTIVE_APPLICATION_STATUSES:35, ActiveApplicationStatus:42, isActiveApplicationStatus:44, displayJobLocation:48 |
...
| [lib/member/loadMemberDashboardHome.test.ts](../../../lib/member/loadMemberDashboardHome.test.ts) | 657 | member-counselor |  |
...
| [lib/member/persistedAtRisk.ts](../../../lib/member/persistedAtRisk.ts) | 93 | member-counselor | ACTIVE_AT_RISK_STATUSES:9, PersistedRiskScope:11, PersistedAtRiskMember:15, loadPersistedAtRiskMembers:36, persistedRiskCommandRow:85 |
| [lib/member/points.ts](../../../lib/member/points.ts) | 77 | member-counselor | LevelName:7, getLevelForPoints:8, getNextLevel:8, LEVELS:8, awardPoints:14, getMemberPoints:57, getStreak:77 |
...
| [lib/member/referrals.ts](../../../lib/member/referrals.ts) | 279 | applications-enrollment | MEMBER_REFERRAL_COOKIE:41, REFERRAL_CODE_PATTERN:42, normalizeReferralCode:43, isValidReferralCode:44, referralRewardEligibility:45, getOrCreateReferralCode:58, resolveReferralCode:80, getRewardedReferralCount:88, CapturePendingReferralResult:104, capturePendingReferral:120, rewardReferralOnEnrollment:171, ReferralSettlementResult:237, settlePendingReferralRewards:252 |
...
| [lib/member/starterProfileReview.ts](../../../lib/member/starterProfileReview.ts) | 46 | member-counselor | StarterProfileField:3, STARTER_PROFILE_FIELD_LABELS:5, getStarterProfileFieldLabels:14, getCounselorStarterProfileReview:18 |
| [lib/member/streakDisplay.ts](../../../lib/member/streakDisplay.ts) | 45 | member-counselor | StoredStreakLike:11, daysSinceLastActive:23, effectiveStreak:38 |
| [lib/member/streaks.test.ts](../../../lib/member/streaks.test.ts) | 79 | member-counselor |  |
| [lib/member/streaks.ts](../../../lib/member/streaks.ts) | 156 | member-counselor | effectiveStreak:5, daysSinceLastActive:5, StreakState:24, computeNextStreak:51, updateStreak:97, getStreak:139 |
| [lib/member/suggestGoalsFromCareer.ts](../../../lib/member/suggestGoalsFromCareer.ts) | 84 | member-counselor | SuggestedGoal:3, suggestGoalsFromCareer:18 |
| [lib/member/trainingCoursePractice.ts](../../../lib/member/trainingCoursePractice.ts) | 31 | member-counselor | TrainingCoursePractice:7, loadTrainingCoursePractice:10 |
| [lib/member/trainingFeedbackDraft.ts](../../../lib/member/trainingFeedbackDraft.ts) | 31 | member-counselor | buildTrainingFeedbackDraft:4 |
| [lib/member/trainingProgress.test.ts](../../../lib/member/trainingProgress.test.ts) | 277 | member-counselor |  |
| [lib/member/trainingProgress.ts](../../../lib/member/trainingProgress.ts) | 175 | member-counselor | TrainingProgress:6, LiveTrainingProgressSummary:13, TrainingProgressEnrollment:19, TrainingProgressAssignment:25, resolveTrainingProgressCurriculumVersion:31, ComputeTrainingProgressArgs:46, resolveTrainingProgressAssignment:59, computeTrainingProgress:113, JOB_READY_TRAINING_PCT:175 |
...
| [lib/messages/counselorInbox.ts](../../../lib/messages/counselorInbox.ts) | 259 | communications | CounselorInboxRow:6, countUnreadMemberMessagesByThread:45, countThreadsWithUnread:76, buildCounselorInboxRows:82 |
| [lib/messages/counselorThread.ts](../../../lib/messages/counselorThread.ts) | 155 | communications | GetOrCreateMemberCounselorThreadOptions:6, ThreadMessageRow:16, compactStringIds:24, getMessageAuthorName:28, resolveAssignedCounselorUserId:32, refreshMemberCounselorThread:48, getOrCreateMemberCounselorThread:64, assertMemberCanAccessThread:84, assertStaffCanAccessThread:91, assertMemberCanPost:132, assertStaffCanPost:136, normalizeMessageBody:140, serializeMessage:147 |
...
| [lib/messages/staffMessageNotification.ts](../../../lib/messages/staffMessageNotification.ts) | 7 | communications | STAFF_MESSAGE_NOTIFICATION_TITLE:7 |
| [lib/messages/superAdminMessageQueries.ts](../../../lib/messages/superAdminMessageQueries.ts) | 182 | communications | ThreadSlaRow:6, getSlaStatusForThreads:20, countThreadsWithSlaBreach:69, countUnansweredMemberThreads:113, countMessageThreadsWithActivity:142, getThreadIdsBreachingSla:149 |
| [lib/messages/unansweredBackfill.test.ts](../../../lib/messages/unansweredBackfill.test.ts) | 62 | communications |  |
| [lib/messages/unansweredBackfill.ts](../../../lib/messages/unansweredBackfill.ts) | 231 | communications | UnansweredThreadRow:20, BackfillPlanEntry:32, NotificationWriter:44, findUnansweredThreadsMissingStaffNotification:55, resolveOrgAdminUserIds:116, planBackfillEntry:135, planUnansweredBackfill:165, prismaNotificationWriter:184, applyUnansweredBackfill:198 |
...
| [lib/milestoneCascade/buildDraftPrompt.ts](../../../lib/milestoneCascade/buildDraftPrompt.ts) | 121 | member-counselor | PromptInput:13, BuiltPrompt:30, CASCADE_PROMPT_VERSION:39, buildDraftPrompt:82 |
| [lib/milestoneCascade/detectCompletionMilestone.ts](../../../lib/milestoneCascade/detectCompletionMilestone.ts) | 94 | member-counselor | MILESTONE_CASCADE_WORKFLOW_KEY:19, DetectCompletionResult:21, detectTrainingMilestone:73, detectCompletionMilestone:86 |
| [lib/milestoneCascade/dispatchState.ts](../../../lib/milestoneCascade/dispatchState.ts) | 79 | member-counselor | CASCADE_IDEMPOTENCY_WINDOW_MS:4, CASCADE_DISPATCH_LEASE_MS:5, CascadeDispatchStateSchema:29, CascadeDispatchState:40, CascadeDispatchEntry:41, CascadeDispatchSummary:42, summarizeCascadeDispatch:47 |
| [lib/milestoneCascade/draftCascade.ts](../../../lib/milestoneCascade/draftCascade.ts) | 197 | member-counselor | DraftCascadeResult:40, draftCascade:58 |
| [lib/milestoneCascade/expireStaleCascades.ts](../../../lib/milestoneCascade/expireStaleCascades.ts) | 42 | member-counselor | AUTO_EXPIRED_REASON_PREFIX:17, ExpireTickResult:19, expireStaleCascades:23 |
| [lib/milestoneCascade/metrics.ts](../../../lib/milestoneCascade/metrics.ts) | 152 | member-counselor | CascadeMetrics:15, getCascadeMetrics:51 |
| [lib/milestoneCascade/milestoneActionPolicy.test.ts](../../../lib/milestoneCascade/milestoneActionPolicy.test.ts) | 34 | member-counselor |  |
| [lib/milestoneCascade/milestoneActionPolicy.ts](../../../lib/milestoneCascade/milestoneActionPolicy.ts) | 14 | member-counselor | isCounselorOnlyMilestone:4, filterMilestoneActions:8 |
| [lib/milestoneCascade/parseDraftResponse.test.ts](../../../lib/milestoneCascade/parseDraftResponse.test.ts) | 131 | member-counselor |  |
| [lib/milestoneCascade/parseDraftResponse.ts](../../../lib/milestoneCascade/parseDraftResponse.ts) | 75 | member-counselor | ParseResult:23, parseDraftResponse:48 |
| [lib/milestoneCascade/queries.ts](../../../lib/milestoneCascade/queries.ts) | 210 | member-counselor | CascadeCardData:21, CascadeScopeFilter:67, resolveCascadeScope:78, listAwaitingApprovalCascades:104, countAwaitingApprovalCascades:157, getCascadeForReview:180 |
| [lib/milestoneCascade/runDraftTick.ts](../../../lib/milestoneCascade/runDraftTick.ts) | 116 | member-counselor | DraftTickResult:26, runMilestoneCascadeDraftTick:41 |
| [lib/milestoneCascade/sendApprovedCascade.ts](../../../lib/milestoneCascade/sendApprovedCascade.ts) | 148 | member-counselor | CascadeDispatchError:13, DraftDispatchOutcome:16, dispatchApprovedDraft:21, DispatchAllResult:33, dispatchApprovedCascade:58 |
| [lib/milestoneCascade/types.ts](../../../lib/milestoneCascade/types.ts) | 110 | member-counselor | MILESTONE_CASCADE_STATUSES:18, MilestoneCascadeStatus:26, MILESTONE_TYPES:37, MilestoneType:44, MILESTONE_CASCADE_TTL_HOURS:47, ActionDraftSchema:93, ActionDraft:99, ActionDraftType:100, CASCADE_DRAFT_RESPONSE_SCHEMA:102, CascadeDraftResponse:109 |
| [lib/nav/activeRoute.ts](../../../lib/nav/activeRoute.ts) | 27 | public-experience | ActiveNavLink:1, isActiveRoute:10, getBestActiveHref:15 |
| [lib/nav/ageBasedNav.ts](../../../lib/nav/ageBasedNav.ts) | 102 | public-experience | filterNavItemsByAge:8, getJobBoardAccessMessage:37, getAgeRestrictedFeatures:68 |
| [lib/nav/marketing-chrome.test.ts](../../../lib/nav/marketing-chrome.test.ts) | 24 | public-experience |  |
| [lib/nav/marketing-chrome.ts](../../../lib/nav/marketing-chrome.ts) | 29 | public-experience | isMarketingChromeHidden:23 |
| [lib/nav/memberToolRoutes.test.ts](../../../lib/nav/memberToolRoutes.test.ts) | 122 | public-experience |  |
...
| [lib/notifications/create.ts](../../../lib/notifications/create.ts) | 197 | communications | NotificationType:11, CreateNotificationInput:27, createNotification:68, createBulkNotifications:142 |
...
| [lib/notify/discord.ts](../../../lib/notify/discord.ts) | 175 | communications | DiscordNotificationLevel:29, DiscordNotificationInput:31, DISCORD_NOTIFICATION_WORKFLOW:53, notifyDiscord:91 |
| [lib/notify/discordRateLimit.test.ts](../../../lib/notify/discordRateLimit.test.ts) | 41 | communications |  |
| [lib/notify/discordRateLimit.ts](../../../lib/notify/discordRateLimit.ts) | 63 | communications | DiscordRateLimiterOptions:13, DiscordAdmission:19, DiscordRateLimiter:21, DISCORD_WEBHOOK_CAPACITY_PER_MINUTE:28, createDiscordRateLimiter:30 |
...
| [lib/og/shareAchievementLinks.test.ts](../../../lib/og/shareAchievementLinks.test.ts) | 51 | libraries |  |
| [lib/og/shareAchievementLinks.ts](../../../lib/og/shareAchievementLinks.ts) | 103 | libraries | SkillCheckpointShareInput:1, CertificateShareInput:10, AchievementSharePathInput:17, getBrowserShareOrigin:49, buildShareAchievementPath:54, buildSkillCheckpointShare:73, buildCertificateShare:90 |
| [lib/og/shareCards.test.ts](../../../lib/og/shareCards.test.ts) | 48 | libraries |  |
| [lib/og/shareCards.ts](../../../lib/og/shareCards.ts) | 87 | libraries | SkillCheckpointShareCard:1, CertificateShareCard:7, OgShareCard:15, parseOgShareCardParams:68 |
| [lib/onboarding/portalTourSteps.test.ts](../../../lib/onboarding/portalTourSteps.test.ts) | 37 | applications-enrollment |  |
| [lib/onboarding/portalTourSteps.ts](../../../lib/onboarding/portalTourSteps.ts) | 13 | applications-enrollment | TourStep:9, MEMBER_PORTAL_TOUR_STEPS:11, EMPLOYER_PORTAL_TOUR_STEPS:12, PARTNER_PORTAL_TOUR_STEPS:13 |
| [lib/onet/client.ts](../../../lib/onet/client.ts) | 369 | libraries | OnetSearchOccupation:9, onetApiGet:80, isOnetConfigured:87, searchOccupations:91, OnetOccupationOverview:126, getOccupation:133, getOccupationSkills:183, getOccupationTasks:213, getOccupationTechnology:232, getOccupationAbilities:249, getOccupationKnowledge:259, getOccupationWorkActivities:269, OnetEducationEntry:279, getOccupationEducation:316, OnetSampleTitle:326, getOccupationSampleTitles:345, getRelatedOccupations:355 |
| [lib/onet/copy.ts](../../../lib/onet/copy.ts) | 41 | libraries | translateOccupationDescription:9, translateTaskLine:29, translateSkillName:39 |
| [lib/onet/interestProfiler.ts](../../../lib/onet/interestProfiler.ts) | 93 | libraries | IpResultRow:8, IpResultsResponse:16, IpCareerRow:22, IpCareersResponse:30, getInterestProfilerResults:40, getInterestProfilerCareers:45, getInterestProfilerQuestions30:58, parseQuestions30Payload:62, fetchAllMiniIpQuestions:81 |
| [lib/onet/interestProfilerCareerFallback.test.ts](../../../lib/onet/interestProfilerCareerFallback.test.ts) | 71 | libraries |  |
| [lib/onet/interestProfilerCareerFallback.ts](../../../lib/onet/interestProfilerCareerFallback.ts) | 169 | libraries | CURATED_RIASEC_CAREERS:16, isAlphabeticalWithinFitTier:106, applyRiasecCareerFallback:141 |
| [lib/onet/ipMapToPrograms.ts](../../../lib/onet/ipMapToPrograms.ts) | 36 | libraries | mapIpCareerRowsToProgramSlugs:12 |
| [lib/onet/jobZoneMap.ts](../../../lib/onet/jobZoneMap.ts) | 72 | libraries | JOB_ZONE_TO_EXPERIENCE_BAND:16, ProgramDifficulty:25, inferProgramDifficulty:28, scoreJobZoneAlignment:47 |
| [lib/onet/knowledgeAreaMap.ts](../../../lib/onet/knowledgeAreaMap.ts) | 85 | libraries | KnowledgeAreaMapping:11, KNOWLEDGE_AREA_MAPPINGS:22, scoreKnowledgeAreas:62 |
| [lib/onet/occupationTitles.ts](../../../lib/onet/occupationTitles.ts) | 89 | libraries | ONET_CODE_PATTERN:16, isRawOnetCode:19, ONET_OCCUPATION_TITLE_FALLBACKS:24, resolveOccupationTitle:78 |
| [lib/onet/programAnchors.ts](../../../lib/onet/programAnchors.ts) | 6 | libraries | ANCHOR_DIGITAL_LITERACY_SLUG:5, ANCHOR_IT_SUPPORT_SLUG:6 |
| [lib/onet/quizSchema.ts](../../../lib/onet/quizSchema.ts) | 24 | libraries | quizAnswersSchema:13, QuizAnswersInput:24 |
| [lib/onet/recommend.ts](../../../lib/onet/recommend.ts) | 308 | libraries | buildProgramPathFromGoal:51, buildCareerMatchResult:115 |
| [lib/onet/skillMapping.ts](../../../lib/onet/skillMapping.ts) | 165 | libraries | SkillMapping:10, SKILL_MAPPINGS:20, scoreSkillMapping:131 |
...
| [lib/outcomes/socialProof.ts](../../../lib/outcomes/socialProof.ts) | 145 | libraries | OutcomesSocialProofRate:6, PlacementStoryCard:8, PartnerOutcomeSnapshot:18, PartnerReferralBadge:25, OutcomesSocialProofBundle:27, isOutcomesSocialProofEnabled:56, formatSuppressedRate:60, buildPartnerReferralBadge:67, getOutcomesSocialProof:92 |
...
| [lib/partner/attentionPagination.ts](../../../lib/partner/attentionPagination.ts) | 97 | partners-funding | ATTENTION_TIERS:4, AttentionTier:5, AttentionCounts:6, AttentionCursor:7, AttentionQueryError:11, parseAttentionQuery:16, encodeAttentionCursor:43, AttentionPageKey:47, AttentionQueryResult:48, buildAttentionPageQuery:54 |
| [lib/partner/attentionQueue.ts](../../../lib/partner/attentionQueue.ts) | 183 | partners-funding | RiskTier:9, staleDaysSince:11, computeRiskTier:15, nextBestAction:22, PartnerAttentionRow:39, AttentionReferral:80, partnerAttentionRows:82, PartnerAttentionPage:137, loadPartnerAttentionPage:141, countPartnerAttention:174, countActionablePartnerAttention:181 |
...
| [lib/partner/partnerType.test.ts](../../../lib/partner/partnerType.test.ts) | 64 | partners-funding |  |
...
| [lib/partner/referralBundle.ts](../../../lib/partner/referralBundle.ts) | 279 | applications-enrollment | ReferralMember:62, PipelineRow:98, loadPartnerReferralBundle:118, toPartnerMembersListRows:242 |
...
| [lib/partner/syncProgramCatalog.ts](../../../lib/partner/syncProgramCatalog.ts) | 21 | partners-funding | syncPartnerProgramCatalog:3 |
| [lib/partners/chsPartner.test.ts](../../../lib/partners/chsPartner.test.ts) | 88 | partners-funding |  |
| [lib/partners/chsPartner.ts](../../../lib/partners/chsPartner.ts) | 78 | partners-funding | CHS_PARTNER_SLUG:20, CHS_ENROLL_PATH:23, CHS_PARTNER_REFERRAL_CODE:29, CHS_PARTNER_CONTACT_EMAIL:32, CHS_PARTNER_NAME:35, CHS_SPONSORSHIP_TERM_LABEL:38, CHS_SPONSORSHIP_STARTS_AT:41, CHS_SPONSORSHIP_ENDS_AT:44, isChsPartnerRef:50, excludeChsPartnerReferralsWhere:60 |
| [lib/partners/sponsorship.test.ts](../../../lib/partners/sponsorship.test.ts) | 210 | partners-funding |  |
| [lib/partners/sponsorship.ts](../../../lib/partners/sponsorship.ts) | 156 | partners-funding | SponsorshipFundingSource:21, DEFAULT_SPONSORSHIP_FUNDING_SOURCE:24, SponsorshipPartner:30, isSponsorshipActive:47, buildFundingNotes:60, buildSponsorshipMessage:97, resolveSponsorshipFundingSource:109, isSeatCapReached:123, SponsoredSeatWhere:130, buildSponsoredSeatWhere:148 |
| [lib/pipeline/memberJourney.test.ts](../../../lib/pipeline/memberJourney.test.ts) | 57 | libraries |  |
| [lib/pipeline/memberJourney.ts](../../../lib/pipeline/memberJourney.ts) | 236 | libraries | MemberJourneyStage:18, JOURNEY_STAGE_LABELS:27, JOURNEY_STAGE_COLORS:37, JOURNEY_STAGE_BG:47, JOURNEY_STAGE_ORDER:57, JourneyMemberData:67, JourneyMember:109, computeJourneyStage:126, computeDaysInStage:171, toJourneyMember:219 |
| [lib/pipeline/stage.test.ts](../../../lib/pipeline/stage.test.ts) | 52 | libraries |  |
| [lib/pipeline/stage.ts](../../../lib/pipeline/stage.ts) | 98 | libraries | PipelineStage:10, PipelineStudent:19, getPipelineStage:37, PIPELINE_STAGE_LABELS:71, PIPELINE_STAGE_COLORS:81, PIPELINE_STAGES_ORDERED:91 |
| [lib/placement-survey/deliveryPayload.ts](../../../lib/placement-survey/deliveryPayload.ts) | 44 | libraries | PlacementSurveyDeliveryPayload:1, createPlacementSurveyDeliveryPayload:11, readPlacementSurveyDeliveryPayload:17 |
...
| [lib/portal/navBadges.ts](../../../lib/portal/navBadges.ts) | 263 | libraries | NavBadgeCounts:14, getNavBadgeCountsForUser:18, isValidPortalBadgeRole:261 |
| [lib/portal/voice/index.ts](../../../lib/portal/voice/index.ts) | 11 | libraries | GOLD_TEXT_GRADIENT:2, readinessVoiceSurface:3, resumeCoachVoiceSurface:4, counselorStaffVoiceSurface:5, studentCounselorVoiceSurface:6, employerVoiceSurface:7, partnerVoiceSurface:8, mockInterviewVoiceSurface:9, careerBusinessVoiceSurface:10 |
| [lib/portal/voiceAgentSurfaces.ts](../../../lib/portal/voiceAgentSurfaces.ts) | 109 | libraries | GOLD_TEXT_GRADIENT:22, readinessVoiceSurface:28, resumeCoachVoiceSurface:40, counselorStaffVoiceSurface:51, studentCounselorVoiceSurface:61, employerVoiceSurface:71, partnerVoiceSurface:81, mockInterviewVoiceSurface:91, careerBusinessVoiceSurface:101 |
...
| [lib/public/publicDataFilters.ts](../../../lib/public/publicDataFilters.ts) | 36 | libraries | isExcludedPublicPartnerName:10, isExcludedPublicSubgroupName:22, sanitizePublicPartnerLabel:28, sanitizePublicSubgroupLabel:33 |
| [lib/push/sendWebPush.ts](../../../lib/push/sendWebPush.ts) | 113 | communications | WEB_PUSH_WORKFLOW:8, isWebPushConfigured:21, WebPushPayload:41, sendWebPushToUser:54 |
| [lib/rate-limit-policy.test.ts](../../../lib/rate-limit-policy.test.ts) | 163 | libraries |  |
| [lib/rate-limit-policy.ts](../../../lib/rate-limit-policy.ts) | 103 | libraries | ALLOW_MISSING_UPSTASH_ENV:21, APPLY_FAIL_CLOSED_ENV:22, MissingLimiterMode:24, MissingLimiterReason:26, MissingLimiterDecision:33, RateLimiterMode:48, resolveRateLimiterMode:50, isAllowMissingUpstashEnabled:60, isApplyFailClosedEnvEnabled:66, decideMissingLimiter:72 |
| [lib/rate-limit.ts](../../../lib/rate-limit.ts) | 753 | libraries | getRateLimiterMode:50, VOICE_SESSION_STARTS_PER_HOUR:112, VOICE_SESSION_LIMIT_MESSAGE:113, checkSignupRateLimit:466, checkApplySignupRateLimit:470, checkAuthRateLimit:474, checkAuthIpRateLimit:483, checkVoiceSessionRateLimit:494, checkSignupEmailRateLimit:505, checkAIToolRateLimit:511, checkResumeUploadRateLimit:517, checkResumeDraftSaveRateLimit:523, checkContactRateLimit:529, checkPartnerSignupRateLimit:534, checkAdminInviteRateLimit:539, checkBulkEmailRateLimit:551, checkEmployerJobImportRateLimit:556, checkConfirmationEmailRateLimit:563, checkConfirmationEmailEmailRateLimit:569, checkCareersRecommendRateLimit:577, checkInterestProfilerRateLimit:584, checkForgotPasswordRateLimit:591, checkForgotPasswordEmailRateLimit:597, checkPublicCareersGetRateLimit:603, checkPublicVoiceSessionRateLimit:610, checkInviteAcceptRateLimit:617, checkPublicInviteValidateRateLimit:624, checkPublicOrgOutcomesRateLimit:631, checkPublicUnsubscribeRateLimit:638, checkVerifyMfaRateLimit:645, checkPublicHealthRateLimit:651, checkXapiConfigGetRateLimit:658, checkXapiOAuthTokenRateLimit:665, checkXapiStatementsPostRateLimit:672, checkPlacementSurveyRateLimit:679, checkPublicWioaQualificationRateLimit:686, checkWebhookRateLimit:693, checkOrgOnboardRateLimit:700, checkPublicInterestProfilerRateLimit:707, checkAdminTokenLinksRateLimit:716, checkPublicQuestionnaireSubmitRateLimit:727, checkCourseraIdentityRateLimit:734, checkMessageSendRateLimit:747 |
...
| [lib/readiness/score.ts](../../../lib/readiness/score.ts) | 331 | libraries | ScoreBreakdown:17, buildScoreBreakdownFromRelations:45, computeReadinessScore:145, getScoreBreakdown:153, ScoreBreakdownSafeResult:202, getScoreBreakdownSafeResult:211, getScoreBreakdownSafe:224, getScoreBreakdowns:229 |
| [lib/recap/buildWeeklyRecapEmailSummary.ts](../../../lib/recap/buildWeeklyRecapEmailSummary.ts) | 135 | libraries | WeeklyRecapJsonForEmail:5, buildWeeklyRecapEmailSummary:48 |
| [lib/recap/generate.ts](../../../lib/recap/generate.ts) | 839 | libraries | RecapWin:12, RecapGoalProgress:24, RecapPlanItem:42, getWeekBounds:310, generateWeeklyRecap:323, MemberRecapInput:538, MemberRecapOutput:545, generateWeeklyRecaps:575 |
| [lib/recap/weekLabel.ts](../../../lib/recap/weekLabel.ts) | 18 | libraries | recapCalendarDateKey:4, formatRecapWeekLabel:9 |
| [lib/referralSources.test.ts](../../../lib/referralSources.test.ts) | 94 | applications-enrollment |  |
| [lib/referralSources.ts](../../../lib/referralSources.ts) | 196 | applications-enrollment | REFERRAL_SOURCE_OTHER_PARTNER:1, REFERRAL_SOURCE_COMMUNITY_AMBASSADOR:2, PARTNER_REFERRAL_SOURCES:10, GENERIC_REFERRAL_CHANNELS:55, CENTRAL_TEXAS_REFERRAL_SOURCES:68, REGIONAL_BOARD_NAME_ALIASES:96, ADMIN_REFERRAL_SOURCE_ACCEPTED_VALUES:123, normalizedReferralSourceKey:177, uniqueReferralSourceOptions:182, ADMIN_REFERRAL_SOURCE_OPTIONS:194 |
| [lib/reporting/programCompletion.test.ts](../../../lib/reporting/programCompletion.test.ts) | 189 | libraries |  |
...
| [lib/resume/extractTextFromResumeBuffer.test.ts](../../../lib/resume/extractTextFromResumeBuffer.test.ts) | 199 | member-counselor |  |
...
| [lib/resume/extractionQuality.ts](../../../lib/resume/extractionQuality.ts) | 105 | member-counselor | RESUME_TEXT_UPLOAD_ERROR:27, RESUME_TEXT_SAVE_ERROR:30, MIN_SUBSTANTIVE_RESUME_TEXT_CHARS:34, isUnsafeResumePlainText:46, sanitizeResumePlainText:74, hasSubstantiveResumeText:83, getResumeExtractionWarning:87 |
| [lib/resume/file-validation.test.ts](../../../lib/resume/file-validation.test.ts) | 220 | member-counselor |  |
| [lib/resume/file-validation.ts](../../../lib/resume/file-validation.ts) | 187 | member-counselor | ALLOWED_MIME_TYPES:3, ALLOWED_EXTENSIONS:10, MAGIC_BYTES:17, validateFileType:23 |
...
| [lib/resume/resumePreviewHtml.ts](../../../lib/resume/resumePreviewHtml.ts) | 9 | member-counselor | resumePlainTextPreviewHtml:1 |
...
| [lib/retention/config.ts](../../../lib/retention/config.ts) | 163 | member-counselor | RetentionTableConfig:22, RETENTION_BATCH_SIZE:33, CRITICAL_AUDIT_ACTION_PREFIXES:46, RETENTION_AUDIT_DAYS:66, PUBLIC_LEAD_RETENTION_DAYS:81, EMAIL_FAILURE_SNAPSHOT_RETENTION_DAYS:88, RETENTION_TABLES:90, DELETED_ACCOUNT_RETENTION_DAYS:155, getCutoffDate:158 |
...
| [lib/storage/publicAssetUrl.ts](../../../lib/storage/publicAssetUrl.ts) | 17 | libraries | resolveSupabasePublicAssetUrl:9 |
| [lib/stripe/client.ts](../../../lib/stripe/client.ts) | 66 | partners-funding | getStripe:3, getStripeWebhookSecret:13, getStripeConnectWebhookSecret:21, EMPLOYER_PRICING_ENFORCED:36, EMPLOYER_TIERS:38, EmployerTierKey:62, isValidTier:64 |
...
| [lib/tenant/adminSubjectAccess.test.ts](../../../lib/tenant/adminSubjectAccess.test.ts) | 48 | identity-tenancy |  |
| [lib/tenant/adminSubjectAccess.ts](../../../lib/tenant/adminSubjectAccess.ts) | 16 | identity-tenancy | canAdminActInSubjectOrganization:9 |
| [lib/tenant/currentRequestHeaders.ts](../../../lib/tenant/currentRequestHeaders.ts) | 15 | identity-tenancy | tryCurrentRequestHeaders:9 |
| [lib/tenant/customDomainCache.ts](../../../lib/tenant/customDomainCache.ts) | 80 | identity-tenancy | CUSTOM_DOMAIN_CACHE_TTL_MS:15, NO_ORG_SENTINEL:18, CustomDomainCache:28, customDomainCache:46 |
| [lib/tenant/hostMatch.test.ts](../../../lib/tenant/hostMatch.test.ts) | 69 | identity-tenancy |  |
| [lib/tenant/hostMatch.ts](../../../lib/tenant/hostMatch.ts) | 70 | identity-tenancy | normalizeHost:27, isCanonicalHost:56 |
| [lib/tenant/organization.ts](../../../lib/tenant/organization.ts) | 85 | identity-tenancy | DEFAULT_ORG_SLUG:4, DEFAULT_ORG_ID:7, getDefaultOrganizationId:12, getActorOrganizationId:44, getSubjectOrganizationId:76 |
| [lib/tenant/organizationBranding.test.ts](../../../lib/tenant/organizationBranding.test.ts) | 201 | identity-tenancy |  |
| [lib/tenant/organizationBranding.ts](../../../lib/tenant/organizationBranding.ts) | 218 | identity-tenancy | OrganizationBranding:40, OrganizationBrandingRow:68, getOrganizationBranding:150, clearOrganizationBrandingCache:207, getDefaultBrandingForTests:216 |
| [lib/tenant/resolveOrgFromRequest.test.ts](../../../lib/tenant/resolveOrgFromRequest.test.ts) | 315 | identity-tenancy |  |
| [lib/tenant/resolveOrgFromRequest.ts](../../../lib/tenant/resolveOrgFromRequest.ts) | 146 | identity-tenancy | WAP_ORG_ID_HEADER:31, WAP_HOST_HEADER:32, HeadersLike:36, CustomDomainLookup:44, ResolveOptions:60, resolveOrgFromRequest:77, tryResolveOrgFromRequest:123 |
| [lib/tenant/resolveProvisionOrg.test.ts](../../../lib/tenant/resolveProvisionOrg.test.ts) | 81 | identity-tenancy |  |
| [lib/tenant/resolveProvisionOrg.ts](../../../lib/tenant/resolveProvisionOrg.ts) | 93 | identity-tenancy | ResolveProvisionOptions:22, extractTrustedMetadataOrgId:37, resolveProvisionOrganizationId:70 |
| [lib/tenant/scopeProxy.test.ts](../../../lib/tenant/scopeProxy.test.ts) | 709 | identity-tenancy |  |
| [lib/tenant/scopeProxy.ts](../../../lib/tenant/scopeProxy.ts) | 546 | identity-tenancy | TenantScopeViolation:21, TENANT_SCOPED_MODELS:40, ParentFkScope:73, PARENT_FK_SCOPED_MODELS:77, makeScopedProxy:129 |
| [lib/tenant/withTenantScope.ts](../../../lib/tenant/withTenantScope.ts) | 207 | identity-tenancy | withTenantScope:64, withActorTenantScope:81, crossTenantOK:94, assertSameTenant:123, memberInOrg:187, counselorInOrg:192, invitationInOrg:197, subgroupInOrg:202, TenantScopeViolation:207, TENANT_SCOPED_MODELS:207, PARENT_FK_SCOPED_MODELS:207, Prisma:207 |
| [lib/test-fixtures/employerRoleSamples.ts](../../../lib/test-fixtures/employerRoleSamples.ts) | 46 | libraries | EMPLOYER_ROLE_SAMPLES:1 |
...
| [lib/validation/careersLead.test.ts](../../../lib/validation/careersLead.test.ts) | 47 | libraries |  |
| [lib/validation/careersLead.ts](../../../lib/validation/careersLead.ts) | 75 | libraries | CareersLeadFieldKey:1, CareersLeadErrorCode:8, CareersLeadPayload:10, validateCareersLeadPayload:23 |
| [lib/validation/coverLetter.ts](../../../lib/validation/coverLetter.ts) | 30 | libraries | coverLetterSchema:3, CoverLetterInput:30 |
| [lib/validation/employer.ts](../../../lib/validation/employer.ts) | 55 | libraries | employerSignupSchema:3, EmployerSignupInput:55 |
| [lib/validation/gapAnalyzer.ts](../../../lib/validation/gapAnalyzer.ts) | 10 | libraries | gapAnalyzerSchema:3, GapAnalyzerInput:10 |
| [lib/validation/interviewPractice.ts](../../../lib/validation/interviewPractice.ts) | 18 | libraries | interviewPracticeSchema:3, InterviewPracticeInput:18 |
| [lib/validation/jobApplication.test.ts](../../../lib/validation/jobApplication.test.ts) | 40 | libraries |  |
| [lib/validation/jobApplication.ts](../../../lib/validation/jobApplication.ts) | 25 | libraries | createJobApplicationSchema:7, updateJobApplicationSchema:17 |
| [lib/validation/jobMatchScorer.ts](../../../lib/validation/jobMatchScorer.ts) | 109 | libraries | jobMatchScorerSchema:85, JobMatchScorerInput:109 |
| [lib/validation/linkedinAbout.ts](../../../lib/validation/linkedinAbout.ts) | 14 | libraries | linkedinAboutSchema:3, LinkedInAboutInput:14 |
| [lib/validation/linkedinHeadline.ts](../../../lib/validation/linkedinHeadline.ts) | 12 | libraries | linkedinHeadlineSchema:3, LinkedInHeadlineInput:12 |
| [lib/validation/member.ts](../../../lib/validation/member.ts) | 85 | libraries | PROGRAM_INTEREST_OPTIONS:4, memberSignupSchema:35, MemberSignupInput:85 |
| [lib/validation/postalCode.test.ts](../../../lib/validation/postalCode.test.ts) | 23 | libraries |  |
| [lib/validation/postalCode.ts](../../../lib/validation/postalCode.ts) | 13 | libraries | POSTAL_CODE_REGEX:9, isValidPostalCode:11 |
| [lib/validation/resumeRewriter.ts](../../../lib/validation/resumeRewriter.ts) | 17 | libraries | resumeRewriterSchema:3, ResumeRewriterInput:17 |
...
| [lib/workflows/careerOS.ts](../../../lib/workflows/careerOS.ts) | 320 | libraries | CAREER_OS_WORKFLOW:17, handleLearningCompletion:23, PROGRAM_COMPLETION_EVENT:217, handleProgramCompletion:226 |
| [lib/workflows/completeCareerOsActions.ts](../../../lib/workflows/completeCareerOsActions.ts) | 45 | libraries | completeCareerOsResumeActions:33, completeCareerOsInterviewActions:40 |
| [lib/workspace-email/provider.ts](../../../lib/workspace-email/provider.ts) | 140 | libraries | WorkspaceEmailProviderId:14, WORKSPACE_EMAIL_DOMAIN:16, WorkspaceEmailUserRef:18, ProvisionInput:25, ProvisionResult:31, RevokeInput:38, RevokeResult:42, WorkspaceEmailProvider:47, deriveLocalPart:57, NoopWorkspaceEmailProvider:75, getWorkspaceEmailAvailability:113, getWorkspaceEmailProvider:122 |
| [lib/xapi/activityTimestamp.ts](../../../lib/xapi/activityTimestamp.ts) | 13 | learning-coursera | xapiLearnerActivityAt:6 |
| [lib/xapi/config.ts](../../../lib/xapi/config.ts) | 61 | learning-coursera | getXapiConfig:19, getXapiReadiness:47 |
| [lib/xapi/inboundStatementPipeline.ts](../../../lib/xapi/inboundStatementPipeline.ts) | 294 | learning-coursera | InboundStatementRunResult:19, handleInboundParsedStatement:27 |
| [lib/xapi/mappings.ts](../../../lib/xapi/mappings.ts) | 999 | learning-coursera | XapiIdentity:10, ResolvedXapiUser:16, ensureCourseraMappingTables:81, resolveXapiUser:360, recordXapiEvent:463, listCourseraIdentityMappings:613, listCourseraIdentityMappingsForUser:641, CourseraSkillsetProgressSummary:667, getCourseraSkillsetProgressSummary:683, CourseraUnmatchedActorAlertStats:736, getCourseraUnmatchedActorAlertStats:746, listRecentUnmatchedXapiEvents:789, upsertCourseraIdentityMapping:831 |
| [lib/xapi/persistXapiStatement.ts](../../../lib/xapi/persistXapiStatement.ts) | 260 | learning-coursera | PersistXapiStatementInput:7, PersistXapiStatementResult:40, PersistXapiStatementOutput:42, InvalidXapiPayloadError:59, persistXapiStatement:135, markXapiStatementProcessed:188, claimCourseraRestWebhookStatement:219 |
| [lib/xapi/persistedOrganization.ts](../../../lib/xapi/persistedOrganization.ts) | 16 | learning-coursera | normalizePersistedXapiOrganizationId:6 |
| [lib/xapi/reprocess.ts](../../../lib/xapi/reprocess.ts) | 399 | learning-coursera | ReprocessResult:22, reprocessUnmatchedXapiEvents:46, autoHealUnmatchedXapiEvents:114, reprocessIgnoredXapiEventsWithMappings:291 |
| [lib/xapi/resolveInboundCourseScopes.test.ts](../../../lib/xapi/resolveInboundCourseScopes.test.ts) | 96 | learning-coursera |  |
| [lib/xapi/resolveInboundCourseScopes.ts](../../../lib/xapi/resolveInboundCourseScopes.ts) | 73 | learning-coursera | InboundCourseScope:10, resolveInboundCourseScopes:27 |
| [lib/xapi/resolveInboundProgram.test.ts](../../../lib/xapi/resolveInboundProgram.test.ts) | 50 | learning-coursera |  |
| [lib/xapi/resolveInboundProgram.ts](../../../lib/xapi/resolveInboundProgram.ts) | 28 | learning-coursera | InboundProgramEnrollment:1, resolveInboundProgramSlug:15 |
| [lib/xapi/statementModel.ts](../../../lib/xapi/statementModel.ts) | 261 | learning-coursera | XapiActivityType:42, ParsedXapiStatement:44, ParsedCompletionStatement:76, flattenXapiStatementPayload:78, parseXapiStatement:108, isXapiCompletionVerb:222, isXapiCourseProgressVerb:245, parseCompletionStatements:256 |
| [lib/xapi/statements.test.ts](../../../lib/xapi/statements.test.ts) | 86 | learning-coursera |  |
| [lib/xapi/statements.ts](../../../lib/xapi/statements.ts) | 13 | learning-coursera | ParsedCompletionStatement:4, ParsedXapiStatement:5, flattenXapiStatementPayload:8, isXapiCompletionVerb:9, isXapiCourseProgressVerb:10, parseCompletionStatements:11, parseXapiStatement:12 |
| [lib/xapi/storage.test.ts](../../../lib/xapi/storage.test.ts) | 249 | learning-coursera |  |
| [lib/xapi/storage.ts](../../../lib/xapi/storage.ts) | 8 | learning-coursera | PersistXapiStatementInput:3, claimCourseraRestWebhookStatement:5, markXapiStatementProcessed:6, persistXapiStatement:7 |
| [lib/xapi/token.ts](../../../lib/xapi/token.ts) | 123 | learning-coursera | issueXapiAccessToken:41, verifyXapiAccessToken:64, parseBearerToken:87, secureCredentialEqual:101, parseBasicAuth:108 |
| [lib/xapi/xapiStatementRowToRaw.ts](../../../lib/xapi/xapiStatementRowToRaw.ts) | 55 | learning-coursera | xapiStatementRowToRawStatement:14 |
| [shared/digitalLiteracyPathway.test.ts](../../../shared/digitalLiteracyPathway.test.ts) | 108 | libraries |  |
| [shared/digitalLiteracyPathway.ts](../../../shared/digitalLiteracyPathway.ts) | 284 | libraries | DIGITAL_LITERACY_PROGRAM_SLUG:10, DIGITAL_LITERACY_PROGRAM_TITLE:11, isUngatedDigitalLiteracyProgram:18, DIGITAL_LITERACY_FIRST_COURSE_SLUG:21, DIGITALLEARN_HOME_URL:22, DIGITALLEARN_COURSES_URL:23, DIGITALLEARN_PROVIDER_NAME:24, DIGITALLEARN_VERIFIED_ON:25, DIGITALLEARN_TERMS_URL:26, DIGITALLEARN_LICENSE_NAME:27, DIGITALLEARN_LICENSE_URL:28, DIGITALLEARN_PROVIDER:30, DigitalLiteracyDestinationKind:44, DigitalLiteracyLesson:49, DigitalLiteracyModule:61, DIGITAL_LITERACY_MODULES:86, digitalLiteracyModuleMinutes:253, DIGITAL_LITERACY_TOTAL_MINUTES:257, digitalLiteracyModuleHours:263, DIGITAL_LITERACY_DURATION_LABEL:267, DIGITAL_LITERACY_DESCRIPTION:269, digitalLiteracyCatalogCourses:273 |
| [shared/programCurricula.ts](../../../shared/programCurricula.ts) | 351 | libraries | ProgramCurriculumCourse:30, CurriculumCertificationReference:40, CurriculumVerificationStatus:46, ProgramCurriculum:50, MSSC_CLA_ASSESSMENT_DOMAINS:76, MSSC_CLT_ASSESSMENT_DOMAINS:88, MSSC_CLA_CLT_ASSESSMENT_DOMAINS:100, MSSC_CLT_KEY_ACTIVITIES_REFERENCE:105, PROGRAM_CURRICULA:111, getProgramCurriculum:349 |
| [shared/programSyllabi.ts](../../../shared/programSyllabi.ts) | 1042 | libraries | ProgramSyllabusCourse:10, ProgramSyllabus:24, PROGRAM_SYLLABI:44, ProgramSyllabusSlug:1038, getProgramSyllabus:1040 |
