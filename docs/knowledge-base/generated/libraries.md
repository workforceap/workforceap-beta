...
| [lib/security/csp.ts](../../../lib/security/csp.ts) | 121 | libraries | CSP_NONCE_HEADER:22, CSP_REPORT_ONLY_HEADER:23, CSP_REPORTING_ENDPOINTS_HEADER:25, CSP_REPORT_ENDPOINT_NAME:26, CSP_REPORT_PATH:27, CSP_ENFORCED_DIRECTIVES:30, generateCspNonce:52, isValidCspNonce:60, buildCspReportOnlyPolicy:78, buildReportingEndpointsHeader:92, CspRequestLike:97, isCspNonceDocumentRequest:110 |
| [lib/security/cspReport.ts](../../../lib/security/cspReport.ts) | 151 | libraries | CSP_REPORT_MAX_BYTES:17, CSP_REPORT_MAX_VIOLATIONS_PER_BATCH:18, CSP_REPORT_CONTENT_TYPES:21, CspReportContentType:22, CspViolationSummary:24, CspViolationCount:34, parseCspReportContentType:39, summarizeBlockedUri:58, summarizeDocumentUri:75, extractCspViolations:124, countCspViolations:142 |
| [lib/security/cspReportRateLimit.ts](../../../lib/security/cspReportRateLimit.ts) | 51 | libraries | CSP_REPORTS_PER_MINUTE_PER_IP:22, checkCspReportRateLimit:41, resetCspReportRateLimiterForTests:49 |
