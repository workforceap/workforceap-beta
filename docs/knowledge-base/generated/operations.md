...
| [scripts/audit-points-ledger-drift.ts](../../../scripts/audit-points-ledger-drift.ts) | 137 | operations |  |
...
| [scripts/backfill-user-roles-from-profile.test.ts](../../../scripts/backfill-user-roles-from-profile.test.ts) | 79 | operations |  |
| [scripts/backfill-user-roles-from-profile.ts](../../../scripts/backfill-user-roles-from-profile.ts) | 165 | operations | UserRoleSnapshot:33, BackfillPlan:39, planUserRoleBackfill:50, countByRole:83 |
...
| [scripts/check-duplicate-migrations.mjs](../../../scripts/check-duplicate-migrations.mjs) | 148 | operations |  |
...
| [scripts/check-migration-history.mjs](../../../scripts/check-migration-history.mjs) | 152 | operations | ROOT:32, findEmptyMigrations:49, findTruncatedMigrations:56, mappedModelTables:69, findModelsWithoutTable:78, findBuildScriptsThatAutoResolve:90, readMigrations:97, check:107 |
...
| [scripts/lib/runtime-pool-contract.test.cjs](../../../scripts/lib/runtime-pool-contract.test.cjs) | 90 | operations |  |
...
| [scripts/snapshot-email-failures.ts](../../../scripts/snapshot-email-failures.ts) | 119 | operations |  |
