...
/**
 * /counselor/overview — the Caseload overview. Since 2026-09-20 `/counselor`
 * itself lands on `/counselor/today` (one attention list); this page keeps the
 * KPI row, session list and activity chart, and its `?ui=legacy` path.
 */
